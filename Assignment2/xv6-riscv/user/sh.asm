...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	69e58593          	addi	a1,a1,1694 # 16b0 <uthread_self+0x2a>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	65858593          	addi	a1,a1,1624 # 16b8 <uthread_self+0x32>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	62650513          	addi	a0,a0,1574 # 16c0 <uthread_self+0x3a>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	6f270713          	addi	a4,a4,1778 # 17b8 <uthread_self+0x132>
    ...
    panic("runcmd");
      ...
      e4:	5e850513          	addi	a0,a0,1512 # 16c8 <uthread_self+0x42>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	5ce58593          	addi	a1,a1,1486 # 16d0 <uthread_self+0x4a>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	59258593          	addi	a1,a1,1426 # 16e0 <uthread_self+0x5a>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	50c50513          	addi	a0,a0,1292 # 16f0 <uthread_self+0x6a>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	174b8b93          	addi	s7,s7,372 # 1718 <uthread_self+0x92>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	14250513          	addi	a0,a0,322 # 16f8 <uthread_self+0x72>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	08260613          	addi	a2,a2,130 # 1720 <uthread_self+0x9a>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	072b0b13          	addi	s6,s6,114 # 1740 <uthread_self+0xba>
  ...
  return ret;
     ...
     70c:	02050513          	addi	a0,a0,32 # 1728 <uthread_self+0xa2>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	fc650513          	addi	a0,a0,-58 # 1730 <uthread_self+0xaa>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	fa460613          	addi	a2,a2,-92 # 1748 <uthread_self+0xc2>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	f3ca0a13          	addi	s4,s4,-196 # 1750 <uthread_self+0xca>
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	f0e60613          	addi	a2,a2,-242 # 1758 <uthread_self+0xd2>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	e7060613          	addi	a2,a2,-400 # 1720 <uthread_self+0x9a>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	e9060613          	addi	a2,a2,-368 # 1770 <uthread_self+0xea>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	e3e50513          	addi	a0,a0,-450 # 1760 <uthread_self+0xda>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	e4650513          	addi	a0,a0,-442 # 1778 <uthread_self+0xf2>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	e7270713          	addi	a4,a4,-398 # 17d0 <uthread_self+0x14a>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	e0e60613          	addi	a2,a2,-498 # 1818 <digits+0x28>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a44:	d5058593          	addi	a1,a1,-688 # 1790 <uthread_self+0x10a>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	6de080e7          	jalr	1758(ra) # 1128 <fprintf>
    panic("syntax");
     a52:	00001517          	auipc	a0,0x1
     a56:	cd650513          	addi	a0,a0,-810 # 1728 <uthread_self+0xa2>
...
0000000000000a62 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a78:	d2c48493          	addi	s1,s1,-724 # 17a0 <uthread_self+0x11a>
     a7c:	4589                	li	a1,2
     a7e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     ab6:	cf6a8a93          	addi	s5,s5,-778 # 17a8 <uthread_self+0x122>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ec6:	92e50513          	addi	a0,a0,-1746 # 17f0 <digits>
     eca:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f92:	862b8b93          	addi	s7,s7,-1950 # 17f0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10d2:	71a90913          	addi	s2,s2,1818 # 17e8 <uthread_self+0x162>
        while(*s != 0){
...
0000000000001362 <uthread_create>:
...
int uthread_create(void (*start_func)(), enum sched_priority priority)
{
    ...
    136c:	cb478793          	addi	a5,a5,-844 # 201c <ids>
    1370:	0007a303          	lw	t1,0(a5)
    1374:	2305                	addiw	t1,t1,1
    1376:	0067a023          	sw	t1,0(a5)

    for (i = 0; i < MAX_UTHREADS; i++)
    137a:	00002717          	auipc	a4,0x2
    137e:	cce70713          	addi	a4,a4,-818 # 3048 <uthreads+0xfa0>
    1382:	4781                	li	a5,0
    1384:	6605                	lui	a2,0x1
    1386:	02060613          	addi	a2,a2,32 # 1020 <vprintf+0xd6>
    138a:	4811                	li	a6,4
    {
        if (uthreads[i].state == FREE)
    138c:	4314                	lw	a3,0(a4)
    138e:	c699                	beqz	a3,139c <uthread_create+0x3a>
    for (i = 0; i < MAX_UTHREADS; i++)
    1390:	2785                	addiw	a5,a5,1
    1392:	9732                	add	a4,a4,a2
    1394:	ff079ce3          	bne	a5,a6,138c <uthread_create+0x2a>
            break;
    }     
    ...
    if (i == MAX_UTHREADS)
        return -1;
    1398:	557d                	li	a0,-1
    139a:	a889                	j	13ec <uthread_create+0x8a>
    if (i == MAX_UTHREADS)
    139c:	4711                	li	a4,4
    139e:	04e78a63          	beq	a5,a4,13f2 <uthread_create+0x90>

    uthreads[i].context.ra = (uint64)start_func;
    13a2:	00001897          	auipc	a7,0x1
    13a6:	d0688893          	addi	a7,a7,-762 # 20a8 <uthreads>
    13aa:	00779693          	slli	a3,a5,0x7
    13ae:	00f68633          	add	a2,a3,a5
    13b2:	0616                	slli	a2,a2,0x5
    13b4:	9646                	add	a2,a2,a7
    13b6:	6805                	lui	a6,0x1
    13b8:	00c80e33          	add	t3,a6,a2
    13bc:	faae3423          	sd	a0,-88(t3)
    uthreads[i].context.sp = (uint64)(&uthreads[i].ustack[STACK_SIZE]);
    uthreads[i].context.sp += sizeof(uint64);
    13c0:	00f68733          	add	a4,a3,a5
    13c4:	0716                	slli	a4,a4,0x5
    uthreads[i].context.sp = (uint64)(&uthreads[i].ustack[STACK_SIZE]);
    13c6:	fa080513          	addi	a0,a6,-96 # fa0 <vprintf+0x56>
    13ca:	972a                	add	a4,a4,a0
    13cc:	9746                	add	a4,a4,a7
    uthreads[i].context.sp += sizeof(uint64);
    13ce:	0721                	addi	a4,a4,8
    13d0:	faee3823          	sd	a4,-80(t3)
    uthreads[i].state = RUNNABLE;
    13d4:	4709                	li	a4,2
    13d6:	faee2023          	sw	a4,-96(t3)
    uthreads[i].priority = priority;
    13da:	00be2c23          	sw	a1,24(t3)
    currentThread = &uthreads[i];
    13de:	00001717          	auipc	a4,0x1
    13e2:	c4c73123          	sd	a2,-958(a4) # 2020 <currentThread>

    currentThread->pid = ids;
    13e6:	006e2e23          	sw	t1,28(t3)

    return 0;
    13ea:	4501                	li	a0,0
}
    13ec:	6422                	ld	s0,8(sp)
    13ee:	0141                	addi	sp,sp,16
    13f0:	8082                	ret
        return -1;
    13f2:	557d                	li	a0,-1
    13f4:	bfe5                	j	13ec <uthread_create+0x8a>

00000000000013f6 <get_state>:
...
char* get_state(enum tstate s){
    ...
    13f8:	e422                	sd	s0,8(sp)
    13fa:	0800                	addi	s0,sp,16
  switch (s)
    13fc:	4705                	li	a4,1
    13fe:	02e50763          	beq	a0,a4,142c <get_state+0x36>
    1402:	87aa                	mv	a5,a0
    1404:	4709                	li	a4,2
  case FREE:
    return "FREE";
  ...
  case RUNNABLE:
    ...
    140a:	40a50513          	addi	a0,a0,1034 # 1810 <digits+0x20>
  switch (s)
    140e:	00e78763          	beq	a5,a4,141c <get_state+0x26>
  }

  return "ERROR";
    1412:	00000517          	auipc	a0,0x0
    1416:	3f650513          	addi	a0,a0,1014 # 1808 <digits+0x18>
  switch (s)
    141a:	c781                	beqz	a5,1422 <get_state+0x2c>
}
    141c:	6422                	ld	s0,8(sp)
    141e:	0141                	addi	sp,sp,16
    1420:	8082                	ret
    return "FREE";
    1422:	00000517          	auipc	a0,0x0
    1426:	40650513          	addi	a0,a0,1030 # 1828 <digits+0x38>
    142a:	bfcd                	j	141c <get_state+0x26>
  switch (s)
    142c:	00000517          	auipc	a0,0x0
    1430:	3f450513          	addi	a0,a0,1012 # 1820 <digits+0x30>
    1434:	b7e5                	j	141c <get_state+0x26>

0000000000001436 <find_next>:
...
struct uthread *find_next(enum sched_priority priority){
    1436:	1141                	addi	sp,sp,-16
    1438:	e422                	sd	s0,8(sp)
  ...
  j = (currentThread - uthreads + 1) % MAX_UTHREADS;
    ...
    1440:	be473703          	ld	a4,-1052(a4) # 2020 <currentThread>
    1444:	00001797          	auipc	a5,0x1
    1448:	c6478793          	addi	a5,a5,-924 # 20a8 <uthreads>
    144c:	8f1d                	sub	a4,a4,a5
    144e:	8715                	srai	a4,a4,0x5
    1450:	00000797          	auipc	a5,0x0
    1454:	2507b783          	ld	a5,592(a5) # 16a0 <uthread_self+0x1a>
    1458:	02f70733          	mul	a4,a4,a5
    145c:	0705                	addi	a4,a4,1
    145e:	43f75793          	srai	a5,a4,0x3f
    1462:	03e7d693          	srli	a3,a5,0x3e
    1466:	00d707b3          	add	a5,a4,a3
    146a:	8b8d                	andi	a5,a5,3
    146c:	8f95                	sub	a5,a5,a3
    146e:	4691                	li	a3,4

  for(i = 0; i < MAX_UTHREADS; i++){
    if((uthreads[j].state == RUNNABLE || uthreads[j].state == RUNNING) && uthreads[j].priority == priority){
    1470:	00001597          	auipc	a1,0x1
    1474:	c3858593          	addi	a1,a1,-968 # 20a8 <uthreads>
    1478:	6605                	lui	a2,0x1
    147a:	4805                	li	a6,1
    147c:	a819                	j	1492 <find_next+0x5c>
      next = &uthreads[j];
      break;
    }
    j = (j+1) % MAX_UTHREADS;    
    147e:	2785                	addiw	a5,a5,1
    1480:	41f7d71b          	sraiw	a4,a5,0x1f
    1484:	01e7571b          	srliw	a4,a4,0x1e
    1488:	9fb9                	addw	a5,a5,a4
    148a:	8b8d                	andi	a5,a5,3
    148c:	9f99                	subw	a5,a5,a4
  for(i = 0; i < MAX_UTHREADS; i++){
    148e:	36fd                	addiw	a3,a3,-1
    1490:	ce9d                	beqz	a3,14ce <find_next+0x98>
    if((uthreads[j].state == RUNNABLE || uthreads[j].state == RUNNING) && uthreads[j].priority == priority){
    1492:	00779713          	slli	a4,a5,0x7
    1496:	973e                	add	a4,a4,a5
    1498:	0716                	slli	a4,a4,0x5
    149a:	972e                	add	a4,a4,a1
    149c:	9732                	add	a4,a4,a2
    149e:	fa072703          	lw	a4,-96(a4)
    14a2:	377d                	addiw	a4,a4,-1
    14a4:	fce86de3          	bltu	a6,a4,147e <find_next+0x48>
    14a8:	00779713          	slli	a4,a5,0x7
    14ac:	973e                	add	a4,a4,a5
    14ae:	0716                	slli	a4,a4,0x5
    14b0:	972e                	add	a4,a4,a1
    14b2:	9732                	add	a4,a4,a2
    14b4:	4f18                	lw	a4,24(a4)
    14b6:	fca714e3          	bne	a4,a0,147e <find_next+0x48>
      next = &uthreads[j];
    14ba:	00779513          	slli	a0,a5,0x7
    14be:	953e                	add	a0,a0,a5
    14c0:	0516                	slli	a0,a0,0x5
    14c2:	00001797          	auipc	a5,0x1
    14c6:	be678793          	addi	a5,a5,-1050 # 20a8 <uthreads>
    14ca:	953e                	add	a0,a0,a5
      break;
    14cc:	a011                	j	14d0 <find_next+0x9a>
  struct uthread* next = 0;
    14ce:	4501                	li	a0,0
  }
  ...
  return next;
    ...
    14d0:	6422                	ld	s0,8(sp)
    14d2:	0141                	addi	sp,sp,16
    14d4:	8082                	ret

00000000000014d6 <schedule>:
void schedule(){
    14d6:	1101                	addi	sp,sp,-32
    14d8:	ec06                	sd	ra,24(sp)
    14da:	e822                	sd	s0,16(sp)
    14dc:	e426                	sd	s1,8(sp)
    14de:	1000                	addi	s0,sp,32
  cur = currentThread;
    14e0:	00001497          	auipc	s1,0x1
    14e4:	b404b483          	ld	s1,-1216(s1) # 2020 <currentThread>
  next = find_next(HIGH);
    14e8:	4509                	li	a0,2
    14ea:	00000097          	auipc	ra,0x0
    14ee:	f4c080e7          	jalr	-180(ra) # 1436 <find_next>
  if(next == 0)
    14f2:	c915                	beqz	a0,1526 <schedule+0x50>
  currentThread = next;
    14f4:	00001797          	auipc	a5,0x1
    14f8:	b2a7b623          	sd	a0,-1236(a5) # 2020 <currentThread>
  currentThread->state = RUNNING;
    14fc:	6785                	lui	a5,0x1
    14fe:	00f50733          	add	a4,a0,a5
    1502:	4685                	li	a3,1
    1504:	fad72023          	sw	a3,-96(a4)
  uswtch(&cur->context, &next->context);
    1508:	fa878793          	addi	a5,a5,-88 # fa8 <vprintf+0x5e>
    150c:	00f505b3          	add	a1,a0,a5
    1510:	00f48533          	add	a0,s1,a5
    1514:	00000097          	auipc	ra,0x0
    1518:	de4080e7          	jalr	-540(ra) # 12f8 <uswtch>
}
    151c:	60e2                	ld	ra,24(sp)
    151e:	6442                	ld	s0,16(sp)
    1520:	64a2                	ld	s1,8(sp)
    1522:	6105                	addi	sp,sp,32
    1524:	8082                	ret
    next = find_next(MEDIUM);
    1526:	4505                	li	a0,1
    1528:	00000097          	auipc	ra,0x0
    152c:	f0e080e7          	jalr	-242(ra) # 1436 <find_next>
  if(next == 0)
    1530:	f171                	bnez	a0,14f4 <schedule+0x1e>
    next = find_next(LOW);
    1532:	00000097          	auipc	ra,0x0
    1536:	f04080e7          	jalr	-252(ra) # 1436 <find_next>
  if(next == 0)
    153a:	fd4d                	bnez	a0,14f4 <schedule+0x1e>
    exit(-1);
    153c:	557d                	li	a0,-1
    153e:	00000097          	auipc	ra,0x0
    1542:	8a0080e7          	jalr	-1888(ra) # dde <exit>

0000000000001546 <uthread_yield>:
{
    1546:	1141                	addi	sp,sp,-16
    1548:	e406                	sd	ra,8(sp)
    154a:	e022                	sd	s0,0(sp)
    154c:	0800                	addi	s0,sp,16
  currentThread->state = RUNNABLE;
    154e:	00001797          	auipc	a5,0x1
    1552:	ad27b783          	ld	a5,-1326(a5) # 2020 <currentThread>
    1556:	6705                	lui	a4,0x1
    1558:	97ba                	add	a5,a5,a4
    155a:	4709                	li	a4,2
    155c:	fae7a023          	sw	a4,-96(a5)
  schedule();
    1560:	00000097          	auipc	ra,0x0
    1564:	f76080e7          	jalr	-138(ra) # 14d6 <schedule>
}
    1568:	60a2                	ld	ra,8(sp)
    156a:	6402                	ld	s0,0(sp)
    156c:	0141                	addi	sp,sp,16
    156e:	8082                	ret

0000000000001570 <uthread_exit>:

void uthread_exit()
{
    1570:	1141                	addi	sp,sp,-16
    1572:	e406                	sd	ra,8(sp)
    1574:	e022                	sd	s0,0(sp)
    1576:	0800                	addi	s0,sp,16
  currentThread->state = FREE;
    1578:	00001797          	auipc	a5,0x1
    157c:	aa87b783          	ld	a5,-1368(a5) # 2020 <currentThread>
    1580:	6705                	lui	a4,0x1
    1582:	97ba                	add	a5,a5,a4
    1584:	fa07a023          	sw	zero,-96(a5)
  int remainingThreads = 0;
  for (int i = 0; i < MAX_UTHREADS; i++) {
    1588:	00002797          	auipc	a5,0x2
    158c:	ac078793          	addi	a5,a5,-1344 # 3048 <uthreads+0xfa0>
    1590:	00006597          	auipc	a1,0x6
    1594:	b3858593          	addi	a1,a1,-1224 # 70c8 <uthreads+0x5020>
  int remainingThreads = 0;
    1598:	4501                	li	a0,0
    if (uthreads[i].state == RUNNABLE) 
    159a:	4609                	li	a2,2
  for (int i = 0; i < MAX_UTHREADS; i++) {
    159c:	6685                	lui	a3,0x1
    159e:	02068693          	addi	a3,a3,32 # 1020 <vprintf+0xd6>
    15a2:	a021                	j	15aa <uthread_exit+0x3a>
    15a4:	97b6                	add	a5,a5,a3
    15a6:	00b78763          	beq	a5,a1,15b4 <uthread_exit+0x44>
    if (uthreads[i].state == RUNNABLE) 
    15aa:	4398                	lw	a4,0(a5)
    15ac:	fec71ce3          	bne	a4,a2,15a4 <uthread_exit+0x34>
      remainingThreads++;
    15b0:	2505                	addiw	a0,a0,1
    15b2:	bfcd                	j	15a4 <uthread_exit+0x34>
  }

  if (remainingThreads == 0){
    15b4:	c909                	beqz	a0,15c6 <uthread_exit+0x56>
    exit(0);
  }
  else 
  {
    ...
    15ba:	f20080e7          	jalr	-224(ra) # 14d6 <schedule>
  }
}
    15be:	60a2                	ld	ra,8(sp)
    15c0:	6402                	ld	s0,0(sp)
    15c2:	0141                	addi	sp,sp,16
    15c4:	8082                	ret
    exit(0);
    15c6:	00000097          	auipc	ra,0x0
    15ca:	818080e7          	jalr	-2024(ra) # dde <exit>

00000000000015ce <uthread_set_priority>:

enum sched_priority uthread_set_priority(enum sched_priority priority)
{
    15ce:	1141                	addi	sp,sp,-16
    15d0:	e422                	sd	s0,8(sp)
    15d2:	0800                	addi	s0,sp,16
  enum sched_priority prevPriority = currentThread->priority;
    15d4:	00001797          	auipc	a5,0x1
    15d8:	a4c7b783          	ld	a5,-1460(a5) # 2020 <currentThread>
    15dc:	6705                	lui	a4,0x1
    15de:	97ba                	add	a5,a5,a4
    15e0:	4f98                	lw	a4,24(a5)
  currentThread->priority = priority;
    15e2:	cf88                	sw	a0,24(a5)
  return prevPriority;
}
    15e4:	853a                	mv	a0,a4
    15e6:	6422                	ld	s0,8(sp)
    15e8:	0141                	addi	sp,sp,16
    15ea:	8082                	ret

00000000000015ec <uthread_get_priority>:

enum sched_priority uthread_get_priority()
{
    15ec:	1141                	addi	sp,sp,-16
    15ee:	e422                	sd	s0,8(sp)
    15f0:	0800                	addi	s0,sp,16
    return currentThread->priority;
    15f2:	00001797          	auipc	a5,0x1
    15f6:	a2e7b783          	ld	a5,-1490(a5) # 2020 <currentThread>
    15fa:	6705                	lui	a4,0x1
    15fc:	97ba                	add	a5,a5,a4
}
    15fe:	4f88                	lw	a0,24(a5)
    1600:	6422                	ld	s0,8(sp)
    1602:	0141                	addi	sp,sp,16
    1604:	8082                	ret

0000000000001606 <uthread_start_all>:

int uthreadStarted = 0;

int uthread_start_all() {
    1606:	7175                	addi	sp,sp,-144
    1608:	e506                	sd	ra,136(sp)
    160a:	e122                	sd	s0,128(sp)
    160c:	fca6                	sd	s1,120(sp)
    160e:	0900                	addi	s0,sp,144
  if (uthreadStarted) {
    1610:	00001497          	auipc	s1,0x1
    1614:	a084a483          	lw	s1,-1528(s1) # 2018 <uthreadStarted>
    1618:	e4ad                	bnez	s1,1682 <uthread_start_all+0x7c>
    return -1;
  }
  uthreadStarted = 1;
    161a:	4785                	li	a5,1
    161c:	00001717          	auipc	a4,0x1
    1620:	9ef72e23          	sw	a5,-1540(a4) # 2018 <uthreadStarted>
  ...
  next = find_next(HIGH);
    ...
    162a:	e10080e7          	jalr	-496(ra) # 1436 <find_next>
  if(next == 0)
    162e:	c915                	beqz	a0,1662 <uthread_start_all+0x5c>
  if(next == 0)
    next = find_next(LOW);
  if(next == 0)
    exit(-1);
  ...
  currentThread = next;
    ...
    1634:	9ea7b823          	sd	a0,-1552(a5) # 2020 <currentThread>
  currentThread->state = RUNNING;
    1638:	6585                	lui	a1,0x1
    163a:	00b507b3          	add	a5,a0,a1
    163e:	4705                	li	a4,1
    1640:	fae7a023          	sw	a4,-96(a5)

  uswtch(&dummyContext, &currentThread->context);
    1644:	fa858593          	addi	a1,a1,-88 # fa8 <vprintf+0x5e>
    1648:	95aa                	add	a1,a1,a0
    164a:	f7040513          	addi	a0,s0,-144
    164e:	00000097          	auipc	ra,0x0
    1652:	caa080e7          	jalr	-854(ra) # 12f8 <uswtch>

  return 0;
}
    1656:	8526                	mv	a0,s1
    1658:	60aa                	ld	ra,136(sp)
    165a:	640a                	ld	s0,128(sp)
    165c:	74e6                	ld	s1,120(sp)
    165e:	6149                	addi	sp,sp,144
    1660:	8082                	ret
    next = find_next(MEDIUM);
    1662:	4505                	li	a0,1
    1664:	00000097          	auipc	ra,0x0
    1668:	dd2080e7          	jalr	-558(ra) # 1436 <find_next>
  if(next == 0)
    166c:	f171                	bnez	a0,1630 <uthread_start_all+0x2a>
    next = find_next(LOW);
    166e:	00000097          	auipc	ra,0x0
    1672:	dc8080e7          	jalr	-568(ra) # 1436 <find_next>
  if(next == 0)
    1676:	fd4d                	bnez	a0,1630 <uthread_start_all+0x2a>
    exit(-1);
    1678:	557d                	li	a0,-1
    167a:	fffff097          	auipc	ra,0xfffff
    167e:	764080e7          	jalr	1892(ra) # dde <exit>
    return -1;
    1682:	54fd                	li	s1,-1
    1684:	bfc9                	j	1656 <uthread_start_all+0x50>

0000000000001686 <uthread_self>:


struct uthread *uthread_self()
{
    1686:	1141                	addi	sp,sp,-16
    1688:	e422                	sd	s0,8(sp)
    168a:	0800                	addi	s0,sp,16
    return currentThread;
    168c:	00001517          	auipc	a0,0x1
    1690:	99453503          	ld	a0,-1644(a0) # 2020 <currentThread>
    1694:	6422                	ld	s0,8(sp)
