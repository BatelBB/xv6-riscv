...
main(int argc, char **argv)
{
  ...
  4c:	b7858593          	addi	a1,a1,-1160 # bc0 <uthread_self+0x2c>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d4:	81050513          	addi	a0,a0,-2032 # be0 <digits>
 3d8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a0:	744b8b93          	addi	s7,s7,1860 # be0 <digits>
 ...
 5e0:	5fc90913          	addi	s2,s2,1532 # bd8 <uthread_self+0x44>
        while(*s != 0){
...
0000000000000870 <uthread_create>:
...
int uthread_create(void (*start_func)(), enum sched_priority priority)
{
 ...
 87a:	79678793          	addi	a5,a5,1942 # 100c <ids>
 87e:	0007a303          	lw	t1,0(a5)
 882:	2305                	addiw	t1,t1,1
 884:	0067a023          	sw	t1,0(a5)

    for (i = 0; i < MAX_UTHREADS; i++)
 888:	00001717          	auipc	a4,0x1
 88c:	74870713          	addi	a4,a4,1864 # 1fd0 <uthreads+0xfa0>
 890:	4781                	li	a5,0
 892:	6605                	lui	a2,0x1
 894:	02060613          	addi	a2,a2,32 # 1020 <base>
 898:	4811                	li	a6,4
    {
        if (uthreads[i].state == FREE)
 89a:	4314                	lw	a3,0(a4)
 89c:	c699                	beqz	a3,8aa <uthread_create+0x3a>
    for (i = 0; i < MAX_UTHREADS; i++)
 89e:	2785                	addiw	a5,a5,1
 8a0:	9732                	add	a4,a4,a2
 8a2:	ff079ce3          	bne	a5,a6,89a <uthread_create+0x2a>
            break;
    }     
    ...
    if (i == MAX_UTHREADS)
        return -1;
 8a6:	557d                	li	a0,-1
 8a8:	a889                	j	8fa <uthread_create+0x8a>
    if (i == MAX_UTHREADS)
 8aa:	4711                	li	a4,4
 8ac:	04e78a63          	beq	a5,a4,900 <uthread_create+0x90>

    uthreads[i].context.ra = (uint64)start_func;
 8b0:	00000897          	auipc	a7,0x0
 8b4:	78088893          	addi	a7,a7,1920 # 1030 <uthreads>
 8b8:	00779693          	slli	a3,a5,0x7
 8bc:	00f68633          	add	a2,a3,a5
 8c0:	0616                	slli	a2,a2,0x5
 8c2:	9646                	add	a2,a2,a7
 8c4:	6805                	lui	a6,0x1
 8c6:	00c80e33          	add	t3,a6,a2
 8ca:	faae3423          	sd	a0,-88(t3)
    uthreads[i].context.sp = (uint64)(&uthreads[i].ustack[STACK_SIZE]);
    uthreads[i].context.sp += sizeof(uint64);
 8ce:	00f68733          	add	a4,a3,a5
 8d2:	0716                	slli	a4,a4,0x5
    uthreads[i].context.sp = (uint64)(&uthreads[i].ustack[STACK_SIZE]);
 8d4:	fa080513          	addi	a0,a6,-96 # fa0 <digits+0x3c0>
 8d8:	972a                	add	a4,a4,a0
 8da:	9746                	add	a4,a4,a7
    uthreads[i].context.sp += sizeof(uint64);
 8dc:	0721                	addi	a4,a4,8
 8de:	faee3823          	sd	a4,-80(t3)
    uthreads[i].state = RUNNABLE;
 8e2:	4709                	li	a4,2
 8e4:	faee2023          	sw	a4,-96(t3)
    uthreads[i].priority = priority;
 8e8:	00be2c23          	sw	a1,24(t3)
    currentThread = &uthreads[i];
 8ec:	00000717          	auipc	a4,0x0
 8f0:	72c73223          	sd	a2,1828(a4) # 1010 <currentThread>

    currentThread->pid = ids;
 8f4:	006e2e23          	sw	t1,28(t3)
 ...
 8fe:	8082                	ret
        return -1;
 900:	557d                	li	a0,-1
 902:	bfe5                	j	8fa <uthread_create+0x8a>

0000000000000904 <get_state>:
...
char* get_state(enum tstate s){
 ...
 908:	0800                	addi	s0,sp,16
  switch (s)
 90a:	4705                	li	a4,1
 90c:	02e50763          	beq	a0,a4,93a <get_state+0x36>
 910:	87aa                	mv	a5,a0
 912:	4709                	li	a4,2
  case FREE:
    return "FREE";
 ...
 918:	2ec50513          	addi	a0,a0,748 # c00 <digits+0x20>
  switch (s)
 91c:	00e78763          	beq	a5,a4,92a <get_state+0x26>
  }

  return "ERROR";
 920:	00000517          	auipc	a0,0x0
 924:	2d850513          	addi	a0,a0,728 # bf8 <digits+0x18>
  switch (s)
 928:	c781                	beqz	a5,930 <get_state+0x2c>
}
 92a:	6422                	ld	s0,8(sp)
 ...
 934:	2e850513          	addi	a0,a0,744 # c18 <digits+0x38>
 938:	bfcd                	j	92a <get_state+0x26>
  switch (s)
 93a:	00000517          	auipc	a0,0x0
 93e:	2d650513          	addi	a0,a0,726 # c10 <digits+0x30>
 942:	b7e5                	j	92a <get_state+0x26>

0000000000000944 <find_next>:
...
struct uthread *find_next(enum sched_priority priority){
 ...
 94e:	6c673703          	ld	a4,1734(a4) # 1010 <currentThread>
 952:	00000797          	auipc	a5,0x0
 956:	6de78793          	addi	a5,a5,1758 # 1030 <uthreads>
 95a:	8f1d                	sub	a4,a4,a5
 95c:	8715                	srai	a4,a4,0x5
 95e:	00000797          	auipc	a5,0x0
 962:	2527b783          	ld	a5,594(a5) # bb0 <uthread_self+0x1c>
 966:	02f70733          	mul	a4,a4,a5
 96a:	0705                	addi	a4,a4,1
 96c:	43f75793          	srai	a5,a4,0x3f
 970:	03e7d693          	srli	a3,a5,0x3e
 974:	00d707b3          	add	a5,a4,a3
 978:	8b8d                	andi	a5,a5,3
 97a:	8f95                	sub	a5,a5,a3
 97c:	4691                	li	a3,4

  for(i = 0; i < MAX_UTHREADS; i++){
    if((uthreads[j].state == RUNNABLE || uthreads[j].state == RUNNING) && uthreads[j].priority == priority){
 97e:	00000597          	auipc	a1,0x0
 982:	6b258593          	addi	a1,a1,1714 # 1030 <uthreads>
 986:	6605                	lui	a2,0x1
 988:	4805                	li	a6,1
 98a:	a819                	j	9a0 <find_next+0x5c>
      next = &uthreads[j];
      break;
    }
    j = (j+1) % MAX_UTHREADS;    
 98c:	2785                	addiw	a5,a5,1
 98e:	41f7d71b          	sraiw	a4,a5,0x1f
 992:	01e7571b          	srliw	a4,a4,0x1e
 996:	9fb9                	addw	a5,a5,a4
 998:	8b8d                	andi	a5,a5,3
 99a:	9f99                	subw	a5,a5,a4
  for(i = 0; i < MAX_UTHREADS; i++){
 99c:	36fd                	addiw	a3,a3,-1
 99e:	ce9d                	beqz	a3,9dc <find_next+0x98>
    if((uthreads[j].state == RUNNABLE || uthreads[j].state == RUNNING) && uthreads[j].priority == priority){
 9a0:	00779713          	slli	a4,a5,0x7
 9a4:	973e                	add	a4,a4,a5
 9a6:	0716                	slli	a4,a4,0x5
 9a8:	972e                	add	a4,a4,a1
 9aa:	9732                	add	a4,a4,a2
 9ac:	fa072703          	lw	a4,-96(a4)
 9b0:	377d                	addiw	a4,a4,-1
 9b2:	fce86de3          	bltu	a6,a4,98c <find_next+0x48>
 9b6:	00779713          	slli	a4,a5,0x7
 9ba:	973e                	add	a4,a4,a5
 9bc:	0716                	slli	a4,a4,0x5
 9be:	972e                	add	a4,a4,a1
 9c0:	9732                	add	a4,a4,a2
 9c2:	4f18                	lw	a4,24(a4)
 9c4:	fca714e3          	bne	a4,a0,98c <find_next+0x48>
      next = &uthreads[j];
 9c8:	00779513          	slli	a0,a5,0x7
 9cc:	953e                	add	a0,a0,a5
 9ce:	0516                	slli	a0,a0,0x5
 9d0:	00000797          	auipc	a5,0x0
 9d4:	66078793          	addi	a5,a5,1632 # 1030 <uthreads>
 9d8:	953e                	add	a0,a0,a5
      break;
 9da:	a011                	j	9de <find_next+0x9a>
  struct uthread* next = 0;
 9dc:	4501                	li	a0,0
  }
...
void schedule(){
 ...
 9f2:	6224b483          	ld	s1,1570(s1) # 1010 <currentThread>
  next = find_next(HIGH);
 9f6:	4509                	li	a0,2
 9f8:	00000097          	auipc	ra,0x0
 9fc:	f4c080e7          	jalr	-180(ra) # 944 <find_next>
  if(next == 0)
 a00:	c915                	beqz	a0,a34 <schedule+0x50>
  currentThread = next;
 a02:	00000797          	auipc	a5,0x0
 a06:	60a7b723          	sd	a0,1550(a5) # 1010 <currentThread>
  currentThread->state = RUNNING;
 a0a:	6785                	lui	a5,0x1
 a0c:	00f50733          	add	a4,a0,a5
 a10:	4685                	li	a3,1
 a12:	fad72023          	sw	a3,-96(a4)
  uswtch(&cur->context, &next->context);
 a16:	fa878793          	addi	a5,a5,-88 # fa8 <digits+0x3c8>
 a1a:	00f505b3          	add	a1,a0,a5
 a1e:	00f48533          	add	a0,s1,a5
 a22:	00000097          	auipc	ra,0x0
 a26:	de4080e7          	jalr	-540(ra) # 806 <uswtch>
}
 ...
 a3a:	f0e080e7          	jalr	-242(ra) # 944 <find_next>
  if(next == 0)
 a3e:	f171                	bnez	a0,a02 <schedule+0x1e>
    next = find_next(LOW);
 a40:	00000097          	auipc	ra,0x0
 a44:	f04080e7          	jalr	-252(ra) # 944 <find_next>
  if(next == 0)
 a48:	fd4d                	bnez	a0,a02 <schedule+0x1e>
    exit(-1);
 a4a:	557d                	li	a0,-1
 a4c:	00000097          	auipc	ra,0x0
 a50:	8a0080e7          	jalr	-1888(ra) # 2ec <exit>

0000000000000a54 <uthread_yield>:
{
 ...
 a60:	5b47b783          	ld	a5,1460(a5) # 1010 <currentThread>
 a64:	6705                	lui	a4,0x1
 a66:	97ba                	add	a5,a5,a4
 a68:	4709                	li	a4,2
 a6a:	fae7a023          	sw	a4,-96(a5)
  schedule();
 a6e:	00000097          	auipc	ra,0x0
 a72:	f76080e7          	jalr	-138(ra) # 9e4 <schedule>
}
 a76:	60a2                	ld	ra,8(sp)
 a78:	6402                	ld	s0,0(sp)
...
void uthread_exit()
{
 ...
 a8a:	58a7b783          	ld	a5,1418(a5) # 1010 <currentThread>
 a8e:	6705                	lui	a4,0x1
 a90:	97ba                	add	a5,a5,a4
 a92:	fa07a023          	sw	zero,-96(a5)
  int remainingThreads = 0;
  for (int i = 0; i < MAX_UTHREADS; i++) {
 a96:	00001797          	auipc	a5,0x1
 a9a:	53a78793          	addi	a5,a5,1338 # 1fd0 <uthreads+0xfa0>
 a9e:	00005597          	auipc	a1,0x5
 aa2:	5b258593          	addi	a1,a1,1458 # 6050 <uthreads+0x5020>
  int remainingThreads = 0;
 aa6:	4501                	li	a0,0
 ...
 aa8:	4609                	li	a2,2
  for (int i = 0; i < MAX_UTHREADS; i++) {
 aaa:	6685                	lui	a3,0x1
 aac:	02068693          	addi	a3,a3,32 # 1020 <base>
 ab0:	a021                	j	ab8 <uthread_exit+0x3a>
 ab2:	97b6                	add	a5,a5,a3
 ab4:	00b78763          	beq	a5,a1,ac2 <uthread_exit+0x44>
    if (uthreads[i].state == RUNNABLE) 
 ab8:	4398                	lw	a4,0(a5)
 aba:	fec71ce3          	bne	a4,a2,ab2 <uthread_exit+0x34>
      remainingThreads++;
 abe:	2505                	addiw	a0,a0,1
 ac0:	bfcd                	j	ab2 <uthread_exit+0x34>
  }

  if (remainingThreads == 0){
 ac2:	c909                	beqz	a0,ad4 <uthread_exit+0x56>
    exit(0);
  }
  else 
  {
 ...
 ac8:	f20080e7          	jalr	-224(ra) # 9e4 <schedule>
  }
}
 acc:	60a2                	ld	ra,8(sp)
 ace:	6402                	ld	s0,0(sp)
 ...
 ad8:	818080e7          	jalr	-2024(ra) # 2ec <exit>

0000000000000adc <uthread_set_priority>:
...
enum sched_priority uthread_set_priority(enum sched_priority priority)
{
 ...
 ae6:	52e7b783          	ld	a5,1326(a5) # 1010 <currentThread>
 aea:	6705                	lui	a4,0x1
 aec:	97ba                	add	a5,a5,a4
 aee:	4f98                	lw	a4,24(a5)
  currentThread->priority = priority;
 af0:	cf88                	sw	a0,24(a5)
  return prevPriority;
}
 af2:	853a                	mv	a0,a4
 af4:	6422                	ld	s0,8(sp)
...
0000000000000afa <uthread_get_priority>:
...
enum sched_priority uthread_get_priority()
{
 ...
 b04:	5107b783          	ld	a5,1296(a5) # 1010 <currentThread>
 b08:	6705                	lui	a4,0x1
 b0a:	97ba                	add	a5,a5,a4
}
 b0c:	4f88                	lw	a0,24(a5)
 b0e:	6422                	ld	s0,8(sp)
 b10:	0141                	addi	sp,sp,16
 b12:	8082                	ret

0000000000000b14 <uthread_start_all>:

int uthreadStarted = 0;

int uthread_start_all() {
 b14:	7175                	addi	sp,sp,-144
 b16:	e506                	sd	ra,136(sp)
 b18:	e122                	sd	s0,128(sp)
 b1a:	fca6                	sd	s1,120(sp)
 b1c:	0900                	addi	s0,sp,144
  if (uthreadStarted) {
 b1e:	00000497          	auipc	s1,0x0
 b22:	4ea4a483          	lw	s1,1258(s1) # 1008 <uthreadStarted>
 b26:	e4ad                	bnez	s1,b90 <uthread_start_all+0x7c>
    return -1;
  }
  uthreadStarted = 1;
 b28:	4785                	li	a5,1
 b2a:	00000717          	auipc	a4,0x0
 b2e:	4cf72f23          	sw	a5,1246(a4) # 1008 <uthreadStarted>
 ...
 b38:	e10080e7          	jalr	-496(ra) # 944 <find_next>
  if(next == 0)
 b3c:	c915                	beqz	a0,b70 <uthread_start_all+0x5c>
  if(next == 0)
    next = find_next(LOW);
  if(next == 0)
    exit(-1);
 ...
 b42:	4ca7b923          	sd	a0,1234(a5) # 1010 <currentThread>
  currentThread->state = RUNNING;
 b46:	6585                	lui	a1,0x1
 b48:	00b507b3          	add	a5,a0,a1
 b4c:	4705                	li	a4,1
 b4e:	fae7a023          	sw	a4,-96(a5)

  uswtch(&dummyContext, &currentThread->context);
 b52:	fa858593          	addi	a1,a1,-88 # fa8 <digits+0x3c8>
 b56:	95aa                	add	a1,a1,a0
 b58:	f7040513          	addi	a0,s0,-144
 b5c:	00000097          	auipc	ra,0x0
 b60:	caa080e7          	jalr	-854(ra) # 806 <uswtch>

  return 0;
}
 b64:	8526                	mv	a0,s1
 b66:	60aa                	ld	ra,136(sp)
 b68:	640a                	ld	s0,128(sp)
 b6a:	74e6                	ld	s1,120(sp)
 b6c:	6149                	addi	sp,sp,144
 b6e:	8082                	ret
    next = find_next(MEDIUM);
 b70:	4505                	li	a0,1
 b72:	00000097          	auipc	ra,0x0
 b76:	dd2080e7          	jalr	-558(ra) # 944 <find_next>
  if(next == 0)
 b7a:	f171                	bnez	a0,b3e <uthread_start_all+0x2a>
    next = find_next(LOW);
 b7c:	00000097          	auipc	ra,0x0
 b80:	dc8080e7          	jalr	-568(ra) # 944 <find_next>
  if(next == 0)
 b84:	fd4d                	bnez	a0,b3e <uthread_start_all+0x2a>
    exit(-1);
 b86:	557d                	li	a0,-1
 b88:	fffff097          	auipc	ra,0xfffff
 b8c:	764080e7          	jalr	1892(ra) # 2ec <exit>
    return -1;
 b90:	54fd                	li	s1,-1
 b92:	bfc9                	j	b64 <uthread_start_all+0x50>

0000000000000b94 <uthread_self>:
...
struct uthread *uthread_self()
{
 ...
 b9e:	47653503          	ld	a0,1142(a0) # 1010 <currentThread>
 ba2:	6422                	ld	s0,8(sp)
