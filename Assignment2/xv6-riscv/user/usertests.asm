...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	48250513          	addi	a0,a0,1154 # 64c0 <uthread_self+0x52>
      ...
      74:	8082                	ret
{
      ...
      84:	46050513          	addi	a0,a0,1120 # 64e0 <uthread_self+0x72>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	45050513          	addi	a0,a0,1104 # 64f8 <uthread_self+0x8a>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	45250513          	addi	a0,a0,1106 # 6518 <uthread_self+0xaa>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	41a50513          	addi	a0,a0,1050 # 6500 <uthread_self+0x92>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	42650513          	addi	a0,a0,1062 # 6528 <uthread_self+0xba>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	42450513          	addi	a0,a0,1060 # 6550 <uthread_self+0xe2>
     134:	00006097          	auipc	ra,0x6
     138:	ae2080e7          	jalr	-1310(ra) # 5c16 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	41050513          	addi	a0,a0,1040 # 6550 <uthread_self+0xe2>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	40c58593          	addi	a1,a1,1036 # 6560 <uthread_self+0xf2>
     15c:	00006097          	auipc	ra,0x6
     160:	a8a080e7          	jalr	-1398(ra) # 5be6 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	3e850513          	addi	a0,a0,1000 # 6550 <uthread_self+0xe2>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	3ec58593          	addi	a1,a1,1004 # 6568 <uthread_self+0xfa>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	3bc50513          	addi	a0,a0,956 # 6550 <uthread_self+0xe2>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	3a650513          	addi	a0,a0,934 # 6570 <uthread_self+0x102>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	31c50513          	addi	a0,a0,796 # 6598 <uthread_self+0x12a>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	308a8a93          	addi	s5,s5,776 # 6598 <uthread_self+0x12a>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	29650513          	addi	a0,a0,662 # 65a8 <uthread_self+0x13a>
     ...
     33a:	29250513          	addi	a0,a0,658 # 65c8 <uthread_self+0x15a>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	28050513          	addi	a0,a0,640 # 65e0 <uthread_self+0x172>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	26c98993          	addi	s3,s3,620 # 65e0 <uthread_self+0x172>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	22050513          	addi	a0,a0,544 # 65e0 <uthread_self+0x172>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	19058593          	addi	a1,a1,400 # 6568 <uthread_self+0xfa>
    ...
    printf("write failed\n");
     ...
     3f2:	21250513          	addi	a0,a0,530 # 6600 <uthread_self+0x192>
    ...
    exit(1);
     ...
     40c:	1e050513          	addi	a0,a0,480 # 65e8 <uthread_self+0x17a>
    ...
    printf("open junk failed\n");
     ...
     426:	1c650513          	addi	a0,a0,454 # 65e8 <uthread_self+0x17a>
  ...
  unlink("junk");
     ...
     44a:	19a50513          	addi	a0,a0,410 # 65e0 <uthread_self+0x172>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	0bea0a13          	addi	s4,s4,190 # 6610 <uthread_self+0x1a2>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	01a50513          	addi	a0,a0,26 # 6618 <uthread_self+0x1aa>
     ...
     620:	01450513          	addi	a0,a0,20 # 6630 <uthread_self+0x1c2>
     ...
     63e:	02650513          	addi	a0,a0,38 # 6660 <uthread_self+0x1f2>
     ...
     658:	03c50513          	addi	a0,a0,60 # 6690 <uthread_self+0x222>
     ...
     676:	02e50513          	addi	a0,a0,46 # 66a0 <uthread_self+0x232>
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b4:	020a0a13          	addi	s4,s4,32 # 66d0 <uthread_self+0x262>
    n = write(fds[1], "x", 1);
     6b8:	00006a97          	auipc	s5,0x6
     6bc:	eb0a8a93          	addi	s5,s5,-336 # 6568 <uthread_self+0xfa>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	f7a50513          	addi	a0,a0,-134 # 66d8 <uthread_self+0x26a>
     ...
     780:	f7450513          	addi	a0,a0,-140 # 66f0 <uthread_self+0x282>
     ...
     79a:	efa50513          	addi	a0,a0,-262 # 6690 <uthread_self+0x222>
     ...
     7b4:	f7050513          	addi	a0,a0,-144 # 6720 <uthread_self+0x2b2>
     ...
     7d2:	f6a50513          	addi	a0,a0,-150 # 6738 <uthread_self+0x2ca>
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	d3c58593          	addi	a1,a1,-708 # 6560 <uthread_self+0xf2>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	d1050513          	addi	a0,a0,-752 # 6550 <uthread_self+0xe2>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	ce450513          	addi	a0,a0,-796 # 6550 <uthread_self+0xe2>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	cd050513          	addi	a0,a0,-816 # 6550 <uthread_self+0xe2>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	f0a58593          	addi	a1,a1,-246 # 67c8 <uthread_self+0x35a>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	c5050513          	addi	a0,a0,-944 # 6550 <uthread_self+0xe2>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	e2450513          	addi	a0,a0,-476 # 6768 <uthread_self+0x2fa>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	e2850513          	addi	a0,a0,-472 # 6788 <uthread_self+0x31a>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     978:	e2450513          	addi	a0,a0,-476 # 6798 <uthread_self+0x32a>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	e2850513          	addi	a0,a0,-472 # 67b8 <uthread_self+0x34a>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a8:	df450513          	addi	a0,a0,-524 # 6798 <uthread_self+0x32a>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	e0e50513          	addi	a0,a0,-498 # 67d0 <uthread_self+0x362>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	e1050513          	addi	a0,a0,-496 # 67f0 <uthread_self+0x382>
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	dfc50513          	addi	a0,a0,-516 # 6810 <uthread_self+0x3a2>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	e0c98993          	addi	s3,s3,-500 # 6838 <uthread_self+0x3ca>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	e3ca8a93          	addi	s5,s5,-452 # 6870 <uthread_self+0x402>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	d9650513          	addi	a0,a0,-618 # 6810 <uthread_self+0x3a2>
  ...
  if(unlink("small") < 0){
     ...
     aba:	d5a50513          	addi	a0,a0,-678 # 6810 <uthread_self+0x3a2>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	d3850513          	addi	a0,a0,-712 # 6818 <uthread_self+0x3aa>
    ...
    exit(1);
     ...
     b02:	d4a50513          	addi	a0,a0,-694 # 6848 <uthread_self+0x3da>
     ...
     b20:	d6450513          	addi	a0,a0,-668 # 6880 <uthread_self+0x412>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	d7050513          	addi	a0,a0,-656 # 68a8 <uthread_self+0x43a>
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	d7450513          	addi	a0,a0,-652 # 68c8 <uthread_self+0x45a>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	d7050513          	addi	a0,a0,-656 # 68e0 <uthread_self+0x472>
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	d5e50513          	addi	a0,a0,-674 # 6900 <uthread_self+0x492>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	d0c50513          	addi	a0,a0,-756 # 6900 <uthread_self+0x492>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	ccc50513          	addi	a0,a0,-820 # 6908 <uthread_self+0x49a>
    ...
    exit(1);
     ...
     c5e:	cce50513          	addi	a0,a0,-818 # 6928 <uthread_self+0x4ba>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	cda50513          	addi	a0,a0,-806 # 6950 <uthread_self+0x4e2>
  ...
  if(unlink("big") < 0){
     ...
     ca6:	c5e50513          	addi	a0,a0,-930 # 6900 <uthread_self+0x492>
     ...
     cd2:	ca250513          	addi	a0,a0,-862 # 6970 <uthread_self+0x502>
     ...
     cf0:	cac50513          	addi	a0,a0,-852 # 6998 <uthread_self+0x52a>
     ...
     d0e:	ca650513          	addi	a0,a0,-858 # 69b0 <uthread_self+0x542>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	cb250513          	addi	a0,a0,-846 # 69d8 <uthread_self+0x56a>
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	c9c50513          	addi	a0,a0,-868 # 69f0 <uthread_self+0x582>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	cb458593          	addi	a1,a1,-844 # 6a20 <uthread_self+0x5b2>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	c6850513          	addi	a0,a0,-920 # 69f0 <uthread_self+0x582>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	c5250513          	addi	a0,a0,-942 # 69f0 <uthread_self+0x582>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	c3c50513          	addi	a0,a0,-964 # 69f0 <uthread_self+0x582>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	ca058593          	addi	a1,a1,-864 # 6a68 <uthread_self+0x5fa>
  ...
  unlink("unlinkread");
     ...
     e34:	bc050513          	addi	a0,a0,-1088 # 69f0 <uthread_self+0x582>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	bb050513          	addi	a0,a0,-1104 # 6a00 <uthread_self+0x592>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	bbc50513          	addi	a0,a0,-1092 # 6a28 <uthread_self+0x5ba>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	bc050513          	addi	a0,a0,-1088 # 6a48 <uthread_self+0x5da>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	bcc50513          	addi	a0,a0,-1076 # 6a70 <uthread_self+0x602>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	bd050513          	addi	a0,a0,-1072 # 6a90 <uthread_self+0x622>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	bd450513          	addi	a0,a0,-1068 # 6ab0 <uthread_self+0x642>
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	ae058593          	addi	a1,a1,-1312 # 6a20 <uthread_self+0x5b2>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	b7858593          	addi	a1,a1,-1160 # 6ad8 <uthread_self+0x66a>
     f68:	00006517          	auipc	a0,0x6
     f6c:	b6850513          	addi	a0,a0,-1176 # 6ad0 <uthread_self+0x662>
  ...
  unlink("lf1");
     ...
     f80:	b5450513          	addi	a0,a0,-1196 # 6ad0 <uthread_self+0x662>
     f84:	00005097          	auipc	ra,0x5
     f88:	c92080e7          	jalr	-878(ra) # 5c16 <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00006517          	auipc	a0,0x6
     f92:	b4250513          	addi	a0,a0,-1214 # 6ad0 <uthread_self+0x662>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	b3450513          	addi	a0,a0,-1228 # 6ad8 <uthread_self+0x66a>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	afc58593          	addi	a1,a1,-1284 # 6ad8 <uthread_self+0x66a>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	ae650513          	addi	a0,a0,-1306 # 6ad8 <uthread_self+0x66a>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c1c080e7          	jalr	-996(ra) # 5c16 <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00006597          	auipc	a1,0x6
    1006:	ace58593          	addi	a1,a1,-1330 # 6ad0 <uthread_self+0x662>
    100a:	00006517          	auipc	a0,0x6
    100e:	ace50513          	addi	a0,a0,-1330 # 6ad8 <uthread_self+0x66a>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	ab258593          	addi	a1,a1,-1358 # 6ad0 <uthread_self+0x662>
    1026:	00006517          	auipc	a0,0x6
    102a:	bba50513          	addi	a0,a0,-1094 # 6be0 <uthread_self+0x772>
    ...
    104c:	a9850513          	addi	a0,a0,-1384 # 6ae0 <uthread_self+0x672>
    ...
    1068:	a9450513          	addi	a0,a0,-1388 # 6af8 <uthread_self+0x68a>
    ...
    1084:	a9050513          	addi	a0,a0,-1392 # 6b10 <uthread_self+0x6a2>
    ...
    10a0:	a9450513          	addi	a0,a0,-1388 # 6b30 <uthread_self+0x6c2>
    ...
    10bc:	aa850513          	addi	a0,a0,-1368 # 6b60 <uthread_self+0x6f2>
    ...
    10d8:	aa450513          	addi	a0,a0,-1372 # 6b78 <uthread_self+0x70a>
    ...
    10f4:	aa050513          	addi	a0,a0,-1376 # 6b90 <uthread_self+0x722>
    ...
    1110:	aac50513          	addi	a0,a0,-1364 # 6bb8 <uthread_self+0x74a>
    ...
    112c:	ac050513          	addi	a0,a0,-1344 # 6be8 <uthread_self+0x77a>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	aae98993          	addi	s3,s3,-1362 # 6c08 <uthread_self+0x79a>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	a8250513          	addi	a0,a0,-1406 # 6c18 <uthread_self+0x7aa>
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	a3ca0a13          	addi	s4,s4,-1476 # 6c38 <uthread_self+0x7ca>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	9ea50513          	addi	a0,a0,-1558 # 6c38 <uthread_self+0x7ca>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	98250513          	addi	a0,a0,-1662 # 6c40 <uthread_self+0x7d2>
    ...
    12e2:	98250513          	addi	a0,a0,-1662 # 6c60 <uthread_self+0x7f2>
    ...
    12fe:	98650513          	addi	a0,a0,-1658 # 6c80 <uthread_self+0x812>
...
000000000000134c <badarg>:
{
    ...
    136a:	19298993          	addi	s3,s3,402 # 64f8 <uthread_self+0x8a>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	ae878793          	addi	a5,a5,-1304 # 7ed8 <uthread_self+0x1a6a>
  ...
  if(pid == 0){
    ...
    1450:	4ac78793          	addi	a5,a5,1196 # 88f8 <uthread_self+0x248a>
    ...
    1474:	08850513          	addi	a0,a0,136 # 64f8 <uthread_self+0x8a>
    ...
    148c:	8a050513          	addi	a0,a0,-1888 # 6d28 <uthread_self+0x8ba>
    ...
    14ac:	7f850513          	addi	a0,a0,2040 # 6ca0 <uthread_self+0x832>
    ...
    14cc:	7f850513          	addi	a0,a0,2040 # 6cc0 <uthread_self+0x852>
    ...
    14ee:	7f650513          	addi	a0,a0,2038 # 6ce0 <uthread_self+0x872>
    ...
    150e:	7fe50513          	addi	a0,a0,2046 # 6d08 <uthread_self+0x89a>
    ...
    1528:	c6450513          	addi	a0,a0,-924 # 7188 <uthread_self+0xd1a>
  ...
  if(st != 747){
    ...
    1572:	7e250513          	addi	a0,a0,2018 # 6d50 <uthread_self+0x8e2>
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	fb050513          	addi	a0,a0,-80 # 6550 <uthread_self+0xe2>
  ...
  if(pid == 0){
    ...
    15ce:	f86a0a13          	addi	s4,s4,-122 # 6550 <uthread_self+0xe2>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	7dea8a93          	addi	s5,s5,2014 # 6db0 <uthread_self+0x942>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    1646:	73e50513          	addi	a0,a0,1854 # 6d80 <uthread_self+0x912>
    ...
    1662:	73a50513          	addi	a0,a0,1850 # 6d98 <uthread_self+0x92a>
    ...
    1680:	74450513          	addi	a0,a0,1860 # 6dc0 <uthread_self+0x952>
    ...
    169e:	eb6a0a13          	addi	s4,s4,-330 # 6550 <uthread_self+0xe2>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	73ea8a93          	addi	s5,s5,1854 # 6de0 <uthread_self+0x972>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f0:	e6450513          	addi	a0,a0,-412 # 6550 <uthread_self+0xe2>
  ...
  exit(xstatus);
    ...
    170e:	68e50513          	addi	a0,a0,1678 # 6d98 <uthread_self+0x92a>
    ...
    172c:	6c050513          	addi	a0,a0,1728 # 6de8 <uthread_self+0x97a>
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	da878793          	addi	a5,a5,-600 # 64f8 <uthread_self+0x8a>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	6ac78793          	addi	a5,a5,1708 # 6e08 <uthread_self+0x99a>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	6a450513          	addi	a0,a0,1700 # 6e10 <uthread_self+0x9a2>
  ...
  if(pid == 0) {
    ...
    179e:	67650513          	addi	a0,a0,1654 # 6e10 <uthread_self+0x9a2>
    ...
    17ba:	67a50513          	addi	a0,a0,1658 # 6e30 <uthread_self+0x9c2>
    ...
    17d6:	5ae50513          	addi	a0,a0,1454 # 6d80 <uthread_self+0x912>
    ...
    17f2:	62a50513          	addi	a0,a0,1578 # 6e18 <uthread_self+0x9aa>
    ...
    1810:	cec50513          	addi	a0,a0,-788 # 64f8 <uthread_self+0x8a>
  ...
  if(xstatus != 0)
    ...
    1844:	60050513          	addi	a0,a0,1536 # 6e40 <uthread_self+0x9d2>
    ...
    1860:	5fc50513          	addi	a0,a0,1532 # 6e58 <uthread_self+0x9ea>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1874:	5a050513          	addi	a0,a0,1440 # 6e10 <uthread_self+0x9a2>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189e:	02e50513          	addi	a0,a0,46 # 68c8 <uthread_self+0x45a>
    ...
    18ba:	4e250513          	addi	a0,a0,1250 # 6d98 <uthread_self+0x92a>
  ...
  unlink("echo-ok");
    ...
    18d4:	54050513          	addi	a0,a0,1344 # 6e10 <uthread_self+0x9a2>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	57650513          	addi	a0,a0,1398 # 6e70 <uthread_self+0xa02>
...
000000000000191e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19c0:	4cc50513          	addi	a0,a0,1228 # 6e88 <uthread_self+0xa1a>
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a46:	45e50513          	addi	a0,a0,1118 # 6ea0 <uthread_self+0xa32>
    ...
    1a62:	45a50513          	addi	a0,a0,1114 # 6eb8 <uthread_self+0xa4a>
    ...
    1a94:	44050513          	addi	a0,a0,1088 # 6ed0 <uthread_self+0xa62>
    ...
    1ad4:	42050513          	addi	a0,a0,1056 # 6ef0 <uthread_self+0xa82>
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b46:	23e50513          	addi	a0,a0,574 # 6d80 <uthread_self+0x912>
    ...
    1b62:	3aa50513          	addi	a0,a0,938 # 6f08 <uthread_self+0xa9a>
    ...
    1b7e:	3a650513          	addi	a0,a0,934 # 6f20 <uthread_self+0xab2>
...
0000000000001b9e <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf6:	18e50513          	addi	a0,a0,398 # 6d80 <uthread_self+0x912>
    ...
    1c1a:	16a50513          	addi	a0,a0,362 # 6d80 <uthread_self+0x912>
...
0000000000001c38 <forkfork>:
{
    ...
    1c94:	2b050513          	addi	a0,a0,688 # 6f40 <uthread_self+0xad2>
    ...
    1ca6:	f24080e7          	jalr	-220(ra) # 5bc6 <exit>
{
    ...
    1cec:	26850513          	addi	a0,a0,616 # 6f50 <uthread_self+0xae2>
...
0000000000001d02 <reparent2>:
{
  ...
  exit(0);
    ...
    1d3a:	45250513          	addi	a0,a0,1106 # 7188 <uthread_self+0xd1a>
...
0000000000001d6a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd8:	3b450513          	addi	a0,a0,948 # 7188 <uthread_self+0xd1a>
    ...
    1e04:	01850513          	addi	a0,a0,24 # 6e18 <uthread_self+0x9aa>
    ...
    1e76:	0fe50513          	addi	a0,a0,254 # 6f70 <uthread_self+0xb02>
    ...
    1eaa:	0e250513          	addi	a0,a0,226 # 6f88 <uthread_self+0xb1a>
    ...
    1f10:	0a450513          	addi	a0,a0,164 # 6fb0 <uthread_self+0xb42>
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb0:	5bc50513          	addi	a0,a0,1468 # 6568 <uthread_self+0xfa>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fec:	580a8a93          	addi	s5,s5,1408 # 6568 <uthread_self+0xfa>
      link("cat", "x");
    1ff0:	00005b97          	auipc	s7,0x5
    1ff4:	fe8b8b93          	addi	s7,s7,-24 # 6fd8 <uthread_self+0xb6a>
    1ff8:	a825                	j	2030 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ffa:	85a6                	mv	a1,s1
    1ffc:	00005517          	auipc	a0,0x5
    2000:	d8450513          	addi	a0,a0,-636 # 6d80 <uthread_self+0x912>
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20c2:	f3a50513          	addi	a0,a0,-198 # 6ff8 <uthread_self+0xb8a>
  ...
  if(wait(0) != -1){
    ...
    2124:	ec050513          	addi	a0,a0,-320 # 6fe0 <uthread_self+0xb72>
    ...
    2140:	ee450513          	addi	a0,a0,-284 # 7020 <uthread_self+0xbb2>
    ...
    215c:	ee050513          	addi	a0,a0,-288 # 7038 <uthread_self+0xbca>
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2198:	48090913          	addi	s2,s2,1152 # 1003d480 <uthreads+0x1002d7e8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21dc:	ba850513          	addi	a0,a0,-1112 # 6d80 <uthread_self+0x912>
    ...
    21fe:	e5650513          	addi	a0,a0,-426 # 7050 <uthread_self+0xbe2>
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2280:	b0450513          	addi	a0,a0,-1276 # 6d80 <uthread_self+0x912>
    ...
    22ac:	dc850513          	addi	a0,a0,-568 # 7070 <uthread_self+0xc02>
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22dc:	db050513          	addi	a0,a0,-592 # 7088 <uthread_self+0xc1a>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230e:	d7e50513          	addi	a0,a0,-642 # 7088 <uthread_self+0xc1a>
  ...
  close(fd);
    ...
    2344:	d5870713          	addi	a4,a4,-680 # 7098 <uthread_self+0xc2a>
    ...
    2398:	de450513          	addi	a0,a0,-540 # 7178 <uthread_self+0xd0a>
    ...
    23bc:	de050513          	addi	a0,a0,-544 # 7198 <uthread_self+0xd2a>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2410:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <uthreads+0xfffffffffffef368>
    2414:	85a6                	mv	a1,s1
    2416:	00005517          	auipc	a0,0x5
    241a:	da250513          	addi	a0,a0,-606 # 71b8 <uthread_self+0xd4a>
    ...
    2436:	94e50513          	addi	a0,a0,-1714 # 6d80 <uthread_self+0x912>
...
0000000000002456 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a4:	8e050513          	addi	a0,a0,-1824 # 6d80 <uthread_self+0x912>
...
00000000000024c4 <manywrites>:
{
  ...
  exit(0);
    ...
    2520:	c6c50513          	addi	a0,a0,-916 # 7188 <uthread_self+0xd1a>
    ...
    25d0:	c1450513          	addi	a0,a0,-1004 # 71e0 <uthread_self+0xd72>
    ...
    25f0:	fdc50513          	addi	a0,a0,-36 # 65c8 <uthread_self+0x15a>
...
000000000000260e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2688:	85478793          	addi	a5,a5,-1964 # 7ed8 <uthread_self+0x1a6a>
  ...
  if(ret != -1){
    ...
    26ca:	b3250513          	addi	a0,a0,-1230 # 71f8 <uthread_self+0xd8a>
    ...
    26e8:	5bc50513          	addi	a0,a0,1468 # 6ca0 <uthread_self+0x832>
    ...
    2706:	5be50513          	addi	a0,a0,1470 # 6cc0 <uthread_self+0x852>
    ...
    2726:	5be50513          	addi	a0,a0,1470 # 6ce0 <uthread_self+0x872>
    ...
    2744:	5c850513          	addi	a0,a0,1480 # 6d08 <uthread_self+0x89a>
...
000000000000275a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2790:	aac50513          	addi	a0,a0,-1364 # 7238 <uthread_self+0xdca>
  ...
  if(n >= 0){
    ...
    27c2:	a9a50513          	addi	a0,a0,-1382 # 7258 <uthread_self+0xdea>
    ...
    27dc:	a2850513          	addi	a0,a0,-1496 # 7200 <uthread_self+0xd92>
    ...
    27f6:	a2650513          	addi	a0,a0,-1498 # 7218 <uthread_self+0xdaa>
    ...
    2810:	a3450513          	addi	a0,a0,-1484 # 7240 <uthread_self+0xdd2>
  ...
  unlink("rwsbrk");
    ...
    2834:	a0850513          	addi	a0,a0,-1528 # 7238 <uthread_self+0xdca>
    2838:	00003097          	auipc	ra,0x3
    283c:	3de080e7          	jalr	990(ra) # 5c16 <unlink>
  fd = open("README", O_RDONLY);
    2840:	4581                	li	a1,0
    2842:	00004517          	auipc	a0,0x4
    2846:	e8e50513          	addi	a0,a0,-370 # 66d0 <uthread_self+0x262>
  ...
  if(n >= 0){
    ...
    2870:	a1c50513          	addi	a0,a0,-1508 # 7288 <uthread_self+0xe1a>
    ...
    288a:	9ba50513          	addi	a0,a0,-1606 # 7240 <uthread_self+0xdd2>
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    28f0:	6705                	lui	a4,0x1
      *b = 99;
    28f2:	00d50023          	sb	a3,0(a0) # 40000000 <uthreads+0x3fff0368>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    290a:	9aa50513          	addi	a0,a0,-1622 # 72b0 <uthread_self+0xe42>
  ...
  for(i = 0; i < 5000; i++){
    ...
    295c:	97850513          	addi	a0,a0,-1672 # 72d0 <uthread_self+0xe62>
  ...
  if(c != a + 1){
    ...
    29c0:	97450513          	addi	a0,a0,-1676 # 7330 <uthread_self+0xec2>
    ...
    29e2:	91250513          	addi	a0,a0,-1774 # 72f0 <uthread_self+0xe82>
    ...
    29fe:	91650513          	addi	a0,a0,-1770 # 7310 <uthread_self+0xea2>
...
0000000000002a3a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2a9c:	fee78fa3          	sb	a4,-1(a5) # 63fffff <uthreads+0x63f0367>
  a = sbrk(0);
    2aa0:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2b00:	fff7c703          	lbu	a4,-1(a5) # 63fffff <uthreads+0x63f0367>
  ...
  if(c != a){
    ...
    2b42:	85ce                	mv	a1,s3
    2b44:	00005517          	auipc	a0,0x5
    2b48:	80c50513          	addi	a0,a0,-2036 # 7350 <uthread_self+0xee2>
    ...
    2b5e:	85ce                	mv	a1,s3
    2b60:	00005517          	auipc	a0,0x5
    2b64:	83850513          	addi	a0,a0,-1992 # 7398 <uthread_self+0xf2a>
    ...
    2b7c:	8626                	mv	a2,s1
    2b7e:	85ce                	mv	a1,s3
    2b80:	00005517          	auipc	a0,0x5
    2b84:	83850513          	addi	a0,a0,-1992 # 73b8 <uthread_self+0xf4a>
    ...
    2ba4:	85850513          	addi	a0,a0,-1960 # 73f8 <uthread_self+0xf8a>
    ...
    2bc0:	86c50513          	addi	a0,a0,-1940 # 7428 <uthread_self+0xfba>
    ...
    2be0:	88450513          	addi	a0,a0,-1916 # 7460 <uthread_self+0xff2>
...
0000000000002bf6 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c1a:	87250513          	addi	a0,a0,-1934 # 7488 <uthread_self+0x101a>
    2c1e:	00003097          	auipc	ra,0x3
    2c22:	fe8080e7          	jalr	-24(ra) # 5c06 <open>
    2c26:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c28:	00005517          	auipc	a0,0x5
    2c2c:	86050513          	addi	a0,a0,-1952 # 7488 <uthread_self+0x101a>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	85ce                	mv	a1,s3
    2c7c:	00005517          	auipc	a0,0x5
    2c80:	81450513          	addi	a0,a0,-2028 # 7490 <uthread_self+0x1022>
    ...
    2c9c:	81050513          	addi	a0,a0,-2032 # 74a8 <uthread_self+0x103a>
    ...
    2cb8:	1d450513          	addi	a0,a0,468 # 6e88 <uthread_self+0xa1a>
...
0000000000002cce <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce2:	7e250513          	addi	a0,a0,2018 # 74c0 <uthread_self+0x1052>
  ...
  close(fd);
    ...
    2d2a:	07250513          	addi	a0,a0,114 # 6d98 <uthread_self+0x92a>
...
0000000000002d40 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d78:	41450513          	addi	a0,a0,1044 # 7188 <uthread_self+0xd1a>
  ...
  if(pid == 0){
    ...
    2dce:	3be50513          	addi	a0,a0,958 # 7188 <uthread_self+0xd1a>
  ...
  if(pid == 0){
    ...
    2e2e:	35e50513          	addi	a0,a0,862 # 7188 <uthread_self+0xd1a>
...
0000000000002f2a <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2f4a:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <uthreads+0xffffffff7fff0367>
...
0000000000002f60 <execout>:
{
  ...
  exit(0);
    ...
    2fa2:	1ea50513          	addi	a0,a0,490 # 7188 <uthread_self+0xd1a>
    ...
    2ff6:	50650513          	addi	a0,a0,1286 # 64f8 <uthread_self+0x8a>
    2ffa:	faa43c23          	sd	a0,-72(s0)
    2ffe:	00003797          	auipc	a5,0x3
    3002:	56a78793          	addi	a5,a5,1386 # 6568 <uthread_self+0xfa>
...
0000000000003024 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3034:	66850513          	addi	a0,a0,1640 # 7698 <uthread_self+0x122a>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3046:	4ae50513          	addi	a0,a0,1198 # 74f0 <uthread_self+0x1082>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    305c:	4f050513          	addi	a0,a0,1264 # 7548 <uthread_self+0x10da>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    307a:	54a50513          	addi	a0,a0,1354 # 75c0 <uthread_self+0x1152>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3096:	59e50513          	addi	a0,a0,1438 # 7630 <uthread_self+0x11c2>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a8:	5e450513          	addi	a0,a0,1508 # 7688 <uthread_self+0x121a>
  ...
  unlink("12345678901234");
    ...
    3126:	3a650513          	addi	a0,a0,934 # 74c8 <uthread_self+0x105a>
    ...
    3142:	3d250513          	addi	a0,a0,978 # 7510 <uthread_self+0x10a2>
    ...
    315e:	41e50513          	addi	a0,a0,1054 # 7578 <uthread_self+0x110a>
    ...
    317a:	47a50513          	addi	a0,a0,1146 # 75f0 <uthread_self+0x1182>
    ...
    3196:	4be50513          	addi	a0,a0,1214 # 7650 <uthread_self+0x11e2>
    ...
    31b2:	4fa50513          	addi	a0,a0,1274 # 76a8 <uthread_self+0x123a>
...
00000000000031c8 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31fe:	4e650513          	addi	a0,a0,1254 # 76e0 <uthread_self+0x1272>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3228:	4cc50513          	addi	a0,a0,1228 # 76f0 <uthread_self+0x1282>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b8:	42c50513          	addi	a0,a0,1068 # 76e0 <uthread_self+0x1272>
  ...
  unlink("diskfulldir");
    ...
    32cc:	41850513          	addi	a0,a0,1048 # 76e0 <uthread_self+0x1272>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33fa:	31a50513          	addi	a0,a0,794 # 7710 <uthread_self+0x12a2>
...
0000000000003408 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3418:	32c50513          	addi	a0,a0,812 # 7740 <uthread_self+0x12d2>
  ...
  if(chdir("iputdir") < 0){
    ...
    342c:	31850513          	addi	a0,a0,792 # 7740 <uthread_self+0x12d2>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3440:	34450513          	addi	a0,a0,836 # 7780 <uthread_self+0x1312>
  ...
  if(chdir("/") < 0){
    ...
    3454:	36050513          	addi	a0,a0,864 # 77b0 <uthread_self+0x1342>
    ...
    3474:	2d850513          	addi	a0,a0,728 # 7748 <uthread_self+0x12da>
    ...
    3490:	2d450513          	addi	a0,a0,724 # 7760 <uthread_self+0x12f2>
    ...
    34ac:	2e850513          	addi	a0,a0,744 # 7790 <uthread_self+0x1322>
    ...
    34c8:	2f450513          	addi	a0,a0,756 # 77b8 <uthread_self+0x134a>
...
00000000000034de <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fc:	24850513          	addi	a0,a0,584 # 7740 <uthread_self+0x12d2>
    ...
    3510:	23450513          	addi	a0,a0,564 # 7740 <uthread_self+0x12d2>
    ...
    3524:	26050513          	addi	a0,a0,608 # 7780 <uthread_self+0x1312>
    ...
    3544:	84050513          	addi	a0,a0,-1984 # 6d80 <uthread_self+0x912>
    ...
    3560:	1ec50513          	addi	a0,a0,492 # 7748 <uthread_self+0x12da>
    ...
    357c:	25850513          	addi	a0,a0,600 # 77d0 <uthread_self+0x1362>
    ...
    3598:	1fc50513          	addi	a0,a0,508 # 7790 <uthread_self+0x1322>
...
00000000000035c6 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d6:	21650513          	addi	a0,a0,534 # 77e8 <uthread_self+0x137a>
  ...
  if(chdir("dir0") < 0){
    ...
    35ea:	20250513          	addi	a0,a0,514 # 77e8 <uthread_self+0x137a>
  ...
  if(chdir("..") < 0){
    ...
    35fe:	20e50513          	addi	a0,a0,526 # 7808 <uthread_self+0x139a>
  ...
  if(unlink("dir0") < 0){
    ...
    3612:	1da50513          	addi	a0,a0,474 # 77e8 <uthread_self+0x137a>
    ...
    3632:	11a50513          	addi	a0,a0,282 # 7748 <uthread_self+0x12da>
    ...
    364e:	1a650513          	addi	a0,a0,422 # 77f0 <uthread_self+0x1382>
    ...
    366a:	1aa50513          	addi	a0,a0,426 # 7810 <uthread_self+0x13a2>
    ...
    3686:	1a650513          	addi	a0,a0,422 # 7828 <uthread_self+0x13ba>
...
000000000000369c <subdir>:
{
  ...
  unlink("ff");
    ...
    36ae:	2c650513          	addi	a0,a0,710 # 7970 <uthread_self+0x1502>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	564080e7          	jalr	1380(ra) # 5c16 <unlink>
  if(mkdir("dd") != 0){
    36ba:	00004517          	auipc	a0,0x4
    36be:	18650513          	addi	a0,a0,390 # 7840 <uthread_self+0x13d2>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d6:	18e50513          	addi	a0,a0,398 # 7860 <uthread_self+0x13f2>
  ...
  write(fd, "ff", 2);
    ...
    36ee:	28658593          	addi	a1,a1,646 # 7970 <uthread_self+0x1502>
  ...
  if(unlink("dd") >= 0){
    ...
    3708:	13c50513          	addi	a0,a0,316 # 7840 <uthread_self+0x13d2>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371c:	1a050513          	addi	a0,a0,416 # 78b8 <uthread_self+0x144a>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3734:	1b050513          	addi	a0,a0,432 # 78e0 <uthread_self+0x1472>
  ...
  write(fd, "FF", 2);
    ...
    374c:	1c858593          	addi	a1,a1,456 # 7910 <uthread_self+0x14a2>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3768:	1b450513          	addi	a0,a0,436 # 7918 <uthread_self+0x14aa>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37b0:	1bc58593          	addi	a1,a1,444 # 7968 <uthread_self+0x14fa>
    37b4:	00004517          	auipc	a0,0x4
    37b8:	12c50513          	addi	a0,a0,300 # 78e0 <uthread_self+0x1472>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37cc:	11850513          	addi	a0,a0,280 # 78e0 <uthread_self+0x1472>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e2:	10250513          	addi	a0,a0,258 # 78e0 <uthread_self+0x1472>
  ...
  if(chdir("dd") != 0){
    ...
    37f6:	04e50513          	addi	a0,a0,78 # 7840 <uthread_self+0x13d2>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380a:	1fa50513          	addi	a0,a0,506 # 7a00 <uthread_self+0x1592>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    381e:	21650513          	addi	a0,a0,534 # 7a30 <uthread_self+0x15c2>
  ...
  if(chdir("./..") != 0){
    ...
    3832:	23250513          	addi	a0,a0,562 # 7a60 <uthread_self+0x15f2>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3848:	12450513          	addi	a0,a0,292 # 7968 <uthread_self+0x14fa>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3882:	06250513          	addi	a0,a0,98 # 78e0 <uthread_self+0x1472>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389a:	25a50513          	addi	a0,a0,602 # 7af0 <uthread_self+0x1682>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b2:	27250513          	addi	a0,a0,626 # 7b20 <uthread_self+0x16b2>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38ca:	f7a50513          	addi	a0,a0,-134 # 7840 <uthread_self+0x13d2>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e0:	f6450513          	addi	a0,a0,-156 # 7840 <uthread_self+0x13d2>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f6:	f4e50513          	addi	a0,a0,-178 # 7840 <uthread_self+0x13d2>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    390a:	2aa58593          	addi	a1,a1,682 # 7bb0 <uthread_self+0x1742>
    390e:	00004517          	auipc	a0,0x4
    3912:	1e250513          	addi	a0,a0,482 # 7af0 <uthread_self+0x1682>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3926:	28e58593          	addi	a1,a1,654 # 7bb0 <uthread_self+0x1742>
    392a:	00004517          	auipc	a0,0x4
    392e:	1f650513          	addi	a0,a0,502 # 7b20 <uthread_self+0x16b2>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3942:	02a58593          	addi	a1,a1,42 # 7968 <uthread_self+0x14fa>
    3946:	00004517          	auipc	a0,0x4
    394a:	f1a50513          	addi	a0,a0,-230 # 7860 <uthread_self+0x13f2>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    395e:	19650513          	addi	a0,a0,406 # 7af0 <uthread_self+0x1682>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3972:	1b250513          	addi	a0,a0,434 # 7b20 <uthread_self+0x16b2>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3986:	fe650513          	addi	a0,a0,-26 # 7968 <uthread_self+0x14fa>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399a:	18a50513          	addi	a0,a0,394 # 7b20 <uthread_self+0x16b2>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39ae:	14650513          	addi	a0,a0,326 # 7af0 <uthread_self+0x1682>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c2:	ea250513          	addi	a0,a0,-350 # 7860 <uthread_self+0x13f2>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d6:	32e50513          	addi	a0,a0,814 # 7d00 <uthread_self+0x1892>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ea:	f8250513          	addi	a0,a0,-126 # 7968 <uthread_self+0x14fa>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39fe:	e6650513          	addi	a0,a0,-410 # 7860 <uthread_self+0x13f2>
  ...
  if(unlink("dd") == 0){
    ...
    3a12:	e3250513          	addi	a0,a0,-462 # 7840 <uthread_self+0x13d2>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a26:	34e50513          	addi	a0,a0,846 # 7d70 <uthread_self+0x1902>
  ...
  if(unlink("dd") < 0){
    ...
    3a3a:	e0a50513          	addi	a0,a0,-502 # 7840 <uthread_self+0x13d2>
    ...
    3a5c:	df050513          	addi	a0,a0,-528 # 7848 <uthread_self+0x13da>
    ...
    3a78:	df450513          	addi	a0,a0,-524 # 7868 <uthread_self+0x13fa>
    ...
    3a94:	df850513          	addi	a0,a0,-520 # 7888 <uthread_self+0x141a>
    ...
    3ab0:	e1450513          	addi	a0,a0,-492 # 78c0 <uthread_self+0x1452>
    ...
    3acc:	e2850513          	addi	a0,a0,-472 # 78f0 <uthread_self+0x1482>
    ...
    3ae8:	e4450513          	addi	a0,a0,-444 # 7928 <uthread_self+0x14ba>
    ...
    3b04:	e4850513          	addi	a0,a0,-440 # 7948 <uthread_self+0x14da>
    ...
    3b20:	e5c50513          	addi	a0,a0,-420 # 7978 <uthread_self+0x150a>
    ...
    3b3c:	e6850513          	addi	a0,a0,-408 # 79a0 <uthread_self+0x1532>
    ...
    3b58:	e6c50513          	addi	a0,a0,-404 # 79c0 <uthread_self+0x1552>
    ...
    3b74:	e7850513          	addi	a0,a0,-392 # 79e8 <uthread_self+0x157a>
    ...
    3b90:	e8450513          	addi	a0,a0,-380 # 7a10 <uthread_self+0x15a2>
    ...
    3bac:	e9850513          	addi	a0,a0,-360 # 7a40 <uthread_self+0x15d2>
    ...
    3bc8:	ea450513          	addi	a0,a0,-348 # 7a68 <uthread_self+0x15fa>
    ...
    3be4:	ea050513          	addi	a0,a0,-352 # 7a80 <uthread_self+0x1612>
    ...
    3c00:	ea450513          	addi	a0,a0,-348 # 7aa0 <uthread_self+0x1632>
    ...
    3c1c:	ea850513          	addi	a0,a0,-344 # 7ac0 <uthread_self+0x1652>
    ...
    3c38:	ecc50513          	addi	a0,a0,-308 # 7b00 <uthread_self+0x1692>
    ...
    3c54:	ee050513          	addi	a0,a0,-288 # 7b30 <uthread_self+0x16c2>
    ...
    3c70:	ee450513          	addi	a0,a0,-284 # 7b50 <uthread_self+0x16e2>
    ...
    3c8c:	ee850513          	addi	a0,a0,-280 # 7b70 <uthread_self+0x1702>
    ...
    3ca8:	eec50513          	addi	a0,a0,-276 # 7b90 <uthread_self+0x1722>
    ...
    3cc4:	f0050513          	addi	a0,a0,-256 # 7bc0 <uthread_self+0x1752>
    ...
    3ce0:	f0c50513          	addi	a0,a0,-244 # 7be8 <uthread_self+0x177a>
    ...
    3cfc:	f1850513          	addi	a0,a0,-232 # 7c10 <uthread_self+0x17a2>
    ...
    3d18:	f2450513          	addi	a0,a0,-220 # 7c38 <uthread_self+0x17ca>
    ...
    3d34:	f2850513          	addi	a0,a0,-216 # 7c58 <uthread_self+0x17ea>
    ...
    3d50:	f2c50513          	addi	a0,a0,-212 # 7c78 <uthread_self+0x180a>
    ...
    3d6c:	f3850513          	addi	a0,a0,-200 # 7ca0 <uthread_self+0x1832>
    ...
    3d88:	f3c50513          	addi	a0,a0,-196 # 7cc0 <uthread_self+0x1852>
    ...
    3da4:	f4050513          	addi	a0,a0,-192 # 7ce0 <uthread_self+0x1872>
    ...
    3dc0:	f4c50513          	addi	a0,a0,-180 # 7d08 <uthread_self+0x189a>
    ...
    3ddc:	bc850513          	addi	a0,a0,-1080 # 79a0 <uthread_self+0x1532>
    ...
    3df8:	f3450513          	addi	a0,a0,-204 # 7d28 <uthread_self+0x18ba>
    ...
    3e14:	f3850513          	addi	a0,a0,-200 # 7d48 <uthread_self+0x18da>
    ...
    3e30:	f4c50513          	addi	a0,a0,-180 # 7d78 <uthread_self+0x190a>
    ...
    3e4c:	f5050513          	addi	a0,a0,-176 # 7d98 <uthread_self+0x192a>
...
0000000000003e62 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e72:	f4250513          	addi	a0,a0,-190 # 7db0 <uthread_self+0x1942>
  ...
  if(chdir("dots") != 0){
    ...
    3e84:	f3050513          	addi	a0,a0,-208 # 7db0 <uthread_self+0x1942>
  ...
  if(unlink(".") == 0){
    ...
    3e96:	d4e50513          	addi	a0,a0,-690 # 6be0 <uthread_self+0x772>
  ...
  if(unlink("..") == 0){
    ...
    3ea8:	96450513          	addi	a0,a0,-1692 # 7808 <uthread_self+0x139a>
  ...
  if(chdir("/") != 0){
    ...
    3eba:	8fa50513          	addi	a0,a0,-1798 # 77b0 <uthread_self+0x1342>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ecc:	f5050513          	addi	a0,a0,-176 # 7e18 <uthread_self+0x19aa>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ede:	f6650513          	addi	a0,a0,-154 # 7e40 <uthread_self+0x19d2>
  ...
  if(unlink("dots") != 0){
    ...
    3ef0:	ec450513          	addi	a0,a0,-316 # 7db0 <uthread_self+0x1942>
    ...
    3f0e:	eae50513          	addi	a0,a0,-338 # 7db8 <uthread_self+0x194a>
    ...
    3f2a:	eaa50513          	addi	a0,a0,-342 # 7dd0 <uthread_self+0x1962>
    ...
    3f46:	ea650513          	addi	a0,a0,-346 # 7de8 <uthread_self+0x197a>
    ...
    3f62:	ea250513          	addi	a0,a0,-350 # 7e00 <uthread_self+0x1992>
    ...
    3f7e:	83e50513          	addi	a0,a0,-1986 # 77b8 <uthread_self+0x134a>
    ...
    3f9a:	e8a50513          	addi	a0,a0,-374 # 7e20 <uthread_self+0x19b2>
    ...
    3fb6:	e9650513          	addi	a0,a0,-362 # 7e48 <uthread_self+0x19da>
    ...
    3fd2:	e9a50513          	addi	a0,a0,-358 # 7e68 <uthread_self+0x19fa>
...
0000000000003fe8 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ffe:	e8e50513          	addi	a0,a0,-370 # 7e88 <uthread_self+0x1a1a>
  ...
  if(chdir("dirfile") == 0){
    ...
    401a:	e7250513          	addi	a0,a0,-398 # 7e88 <uthread_self+0x1a1a>
  ...
  fd = open("dirfile/xx", 0);
    ...
    402e:	ea650513          	addi	a0,a0,-346 # 7ed0 <uthread_self+0x1a62>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4046:	e8e50513          	addi	a0,a0,-370 # 7ed0 <uthread_self+0x1a62>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405a:	e7a50513          	addi	a0,a0,-390 # 7ed0 <uthread_self+0x1a62>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    406e:	e6650513          	addi	a0,a0,-410 # 7ed0 <uthread_self+0x1a62>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4082:	e5258593          	addi	a1,a1,-430 # 7ed0 <uthread_self+0x1a62>
    4086:	00002517          	auipc	a0,0x2
    408a:	64a50513          	addi	a0,a0,1610 # 66d0 <uthread_self+0x262>
  ...
  if(unlink("dirfile") != 0){
    ...
    409e:	dee50513          	addi	a0,a0,-530 # 7e88 <uthread_self+0x1a1a>
  ...
  fd = open(".", O_RDWR);
    ...
    40b4:	b3050513          	addi	a0,a0,-1232 # 6be0 <uthread_self+0x772>
  ...
  fd = open(".", 0);
    ...
    40ca:	b1a50513          	addi	a0,a0,-1254 # 6be0 <uthread_self+0x772>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40de:	48e58593          	addi	a1,a1,1166 # 6568 <uthread_self+0xfa>
  ...
  close(fd);
    ...
    410a:	d8a50513          	addi	a0,a0,-630 # 7e90 <uthread_self+0x1a22>
    ...
    4126:	d8e50513          	addi	a0,a0,-626 # 7eb0 <uthread_self+0x1a42>
    ...
    4142:	da250513          	addi	a0,a0,-606 # 7ee0 <uthread_self+0x1a72>
    ...
    415e:	d8650513          	addi	a0,a0,-634 # 7ee0 <uthread_self+0x1a72>
    ...
    417a:	d9250513          	addi	a0,a0,-622 # 7f08 <uthread_self+0x1a9a>
    ...
    4196:	d9e50513          	addi	a0,a0,-610 # 7f30 <uthread_self+0x1ac2>
    ...
    41b2:	daa50513          	addi	a0,a0,-598 # 7f58 <uthread_self+0x1aea>
    ...
    41ce:	db650513          	addi	a0,a0,-586 # 7f80 <uthread_self+0x1b12>
    ...
    41ea:	dba50513          	addi	a0,a0,-582 # 7fa0 <uthread_self+0x1b32>
    ...
    4206:	dc650513          	addi	a0,a0,-570 # 7fc8 <uthread_self+0x1b5a>
...
000000000000421c <iref>:
{
    ...
    423a:	daaa0a13          	addi	s4,s4,-598 # 7fe0 <uthread_self+0x1b72>
    mkdir("");
    423e:	00004497          	auipc	s1,0x4
    4242:	8aa48493          	addi	s1,s1,-1878 # 7ae8 <uthread_self+0x167a>
    link("README", "");
    4246:	00002a97          	auipc	s5,0x2
    424a:	48aa8a93          	addi	s5,s5,1162 # 66d0 <uthread_self+0x262>
    fd = open("xx", O_CREATE);
    424e:	00004997          	auipc	s3,0x4
    4252:	c8a98993          	addi	s3,s3,-886 # 7ed8 <uthread_self+0x1a6a>
    4256:	a891                	j	42aa <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4258:	85da                	mv	a1,s6
    425a:	00004517          	auipc	a0,0x4
    425e:	d8e50513          	addi	a0,a0,-626 # 7fe8 <uthread_self+0x1b7a>
    ...
    427a:	d8a50513          	addi	a0,a0,-630 # 8000 <uthread_self+0x1b92>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    430e:	4fe98993          	addi	s3,s3,1278 # 7808 <uthread_self+0x139a>
    unlink("irefd");
    4312:	00004917          	auipc	s2,0x4
    4316:	cce90913          	addi	s2,s2,-818 # 7fe0 <uthread_self+0x1b72>
    chdir("..");
    431a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4336:	47e50513          	addi	a0,a0,1150 # 77b0 <uthread_self+0x1342>
...
0000000000004356 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4366:	cb650513          	addi	a0,a0,-842 # 8018 <uthread_self+0x1baa>
  ...
  if(pid == 0){
    ...
    438a:	c9250513          	addi	a0,a0,-878 # 8018 <uthread_self+0x1baa>
    ...
    43a0:	c9c50513          	addi	a0,a0,-868 # 8038 <uthread_self+0x1bca>
    ...
    43bc:	c6850513          	addi	a0,a0,-920 # 8020 <uthread_self+0x1bb2>
    ...
    43d8:	9ac50513          	addi	a0,a0,-1620 # 6d80 <uthread_self+0x912>
  ...
  if(unlink("oidir") != 0){
    ...
    4406:	c1650513          	addi	a0,a0,-1002 # 8018 <uthread_self+0x1baa>
    ...
    441a:	b5a50513          	addi	a0,a0,-1190 # 6f70 <uthread_self+0xb02>
...
0000000000004448 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4458:	c0c50513          	addi	a0,a0,-1012 # 8060 <uthread_self+0x1bf2>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4484:	be050513          	addi	a0,a0,-1056 # 8060 <uthread_self+0x1bf2>
  ...
  sleep(10); // one second
    ...
    44bc:	a8850513          	addi	a0,a0,-1400 # 6f40 <uthread_self+0xad2>
    ...
    44d6:	b8e48493          	addi	s1,s1,-1138 # 8060 <uthread_self+0x1bf2>
    44da:	4581                	li	a1,0
    44dc:	8526                	mv	a0,s1
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	80650513          	addi	a0,a0,-2042 # 6d80 <uthread_self+0x912>
    ...
    45a4:	ad050513          	addi	a0,a0,-1328 # 8070 <uthread_self+0x1c02>
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	96050513          	addi	a0,a0,-1696 # 6f40 <uthread_self+0xad2>
  ...
  if(pid2 == 0)
    ...
    4612:	77250513          	addi	a0,a0,1906 # 6d80 <uthread_self+0x912>
  ...
  if(pid3 == 0){
    ...
    4656:	f1658593          	addi	a1,a1,-234 # 6568 <uthread_self+0xfa>
    ...
    4680:	70450513          	addi	a0,a0,1796 # 6d80 <uthread_self+0x912>
    ...
    469c:	9f850513          	addi	a0,a0,-1544 # 8090 <uthread_self+0x1c22>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	9d450513          	addi	a0,a0,-1580 # 80a8 <uthread_self+0x1c3a>
  ...
  printf("kill... ");
    ...
    4704:	9c050513          	addi	a0,a0,-1600 # 80c0 <uthread_self+0x1c52>
  ...
  printf("wait... ");
    ...
    4732:	9a250513          	addi	a0,a0,-1630 # 80d0 <uthread_self+0x1c62>
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	5d250513          	addi	a0,a0,1490 # 6d80 <uthread_self+0x912>
    ...
    47ce:	73e50513          	addi	a0,a0,1854 # 6f08 <uthread_self+0xa9a>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	64850513          	addi	a0,a0,1608 # 6e88 <uthread_self+0xa1a>
    ...
    4878:	cf458593          	addi	a1,a1,-780 # 6568 <uthread_self+0xfa>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	7a850513          	addi	a0,a0,1960 # 80e0 <uthread_self+0x1c72>
    ...
    4958:	42c50513          	addi	a0,a0,1068 # 6d80 <uthread_self+0x912>
    ...
    498e:	6705                	lui	a4,0x1
      n += *(a+i);
    4990:	0007c683          	lbu	a3,0(a5) # 6400000 <uthreads+0x63f0368>
    ...
    49a4:	76050513          	addi	a0,a0,1888 # 8100 <uthread_self+0x1c92>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a48:	6ec50513          	addi	a0,a0,1772 # 8130 <uthread_self+0x1cc2>
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	66650513          	addi	a0,a0,1638 # 8160 <uthread_self+0x1cf2>
    ...
    4b1a:	67250513          	addi	a0,a0,1650 # 8188 <uthread_self+0x1d1a>
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	5f650513          	addi	a0,a0,1526 # 8150 <uthread_self+0x1ce2>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	60e50513          	addi	a0,a0,1550 # 81a8 <uthread_self+0x1d3a>
  ...
  unlink("sharedfd");
    ...
    4bda:	57a50513          	addi	a0,a0,1402 # 8150 <uthread_self+0x1ce2>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	5d450513          	addi	a0,a0,1492 # 81d0 <uthread_self+0x1d62>
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c46:	85e78793          	addi	a5,a5,-1954 # 64a0 <uthread_self+0x32>
    4c4a:	f6f43823          	sd	a5,-144(s0)
    4c4e:	00002797          	auipc	a5,0x2
    4c52:	85a78793          	addi	a5,a5,-1958 # 64a8 <uthread_self+0x3a>
    4c56:	f6f43c23          	sd	a5,-136(s0)
    4c5a:	00002797          	auipc	a5,0x2
    4c5e:	85678793          	addi	a5,a5,-1962 # 64b0 <uthread_self+0x42>
    4c62:	f8f43023          	sd	a5,-128(s0)
    4c66:	00002797          	auipc	a5,0x2
    4c6a:	85278793          	addi	a5,a5,-1966 # 64b8 <uthread_self+0x4a>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce2:	4aa50513          	addi	a0,a0,1194 # 7188 <uthread_self+0xd1a>
    ...
    4d5e:	48e50513          	addi	a0,a0,1166 # 81e8 <uthread_self+0x1d7a>
    ...
    4d78:	48450513          	addi	a0,a0,1156 # 81f8 <uthread_self+0x1d8a>
    ...
    4da0:	47450513          	addi	a0,a0,1140 # 8210 <uthread_self+0x1da2>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e2e:	3f650513          	addi	a0,a0,1014 # 8220 <uthread_self+0x1db2>
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e90:	3acb8b93          	addi	s7,s7,940 # 8238 <uthread_self+0x1dca>
  for(i = 0; i < N; i++){
    ...
    4ed2:	37250513          	addi	a0,a0,882 # 8240 <uthread_self+0x1dd2>
    ...
    4ef0:	34c50513          	addi	a0,a0,844 # 8238 <uthread_self+0x1dca>
  ...
  fd = open(".", 0);
    ...
    4f28:	cbc50513          	addi	a0,a0,-836 # 6be0 <uthread_self+0x772>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9e:	2c650513          	addi	a0,a0,710 # 8260 <uthread_self+0x1df2>
    ...
    4fbe:	2c650513          	addi	a0,a0,710 # 8280 <uthread_self+0x1e12>
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	2b650513          	addi	a0,a0,694 # 82a8 <uthread_self+0x1e3a>
    ...
    5012:	d7250513          	addi	a0,a0,-654 # 6d80 <uthread_self+0x912>
...
00000000000051bc <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5244:	0a050513          	addi	a0,a0,160 # 82e0 <uthread_self+0x1e72>
  ...
  for(i = 0; ; i++){
    ...
    52a8:	04c50513          	addi	a0,a0,76 # 82f0 <uthread_self+0x1e82>
    ...
    52c4:	05050513          	addi	a0,a0,80 # 8310 <uthread_self+0x1ea2>
    ...
    52e0:	05450513          	addi	a0,a0,84 # 8330 <uthread_self+0x1ec2>
    ...
    52fc:	05850513          	addi	a0,a0,88 # 8350 <uthread_self+0x1ee2>
    ...
    5318:	05c50513          	addi	a0,a0,92 # 8370 <uthread_self+0x1f02>
    ...
    5334:	05850513          	addi	a0,a0,88 # 8388 <uthread_self+0x1f1a>
  ...
  unlink("bigfile.dat");
    ...
    5362:	f8250513          	addi	a0,a0,-126 # 82e0 <uthread_self+0x1e72>
    ...
    5386:	02650513          	addi	a0,a0,38 # 83a8 <uthread_self+0x1f3a>
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	00e50513          	addi	a0,a0,14 # 83c8 <uthread_self+0x1f5a>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53de:	ffec8c93          	addi	s9,s9,-2 # 83d8 <uthread_self+0x1f6a>
    int total = 0;
    53e2:	4d81                	li	s11,0
    ...
    5458:	f9450513          	addi	a0,a0,-108 # 83e8 <uthread_self+0x1f7a>
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	f3e50513          	addi	a0,a0,-194 # 8408 <uthread_self+0x1f9a>
    ...
    551e:	ede50513          	addi	a0,a0,-290 # 83f8 <uthread_self+0x1f8a>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	ed450513          	addi	a0,a0,-300 # 8420 <uthread_self+0x1fb2>
  ...
  if(pid == 0) {
    ...
    5580:	ecc50513          	addi	a0,a0,-308 # 8448 <uthread_self+0x1fda>
    ...
    55a4:	e9050513          	addi	a0,a0,-368 # 8430 <uthread_self+0x1fc2>
    ...
    55cc:	e8850513          	addi	a0,a0,-376 # 8450 <uthread_self+0x1fe2>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	e4050513          	addi	a0,a0,-448 # 8458 <uthread_self+0x1fea>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5676:	ef698993          	addi	s3,s3,-266 # 6568 <uthread_self+0xfa>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a8:	e0c50513          	addi	a0,a0,-500 # 84b0 <uthread_self+0x2042>
    ...
    56c2:	db250513          	addi	a0,a0,-590 # 8470 <uthread_self+0x2002>
    ...
    56dc:	db850513          	addi	a0,a0,-584 # 8490 <uthread_self+0x2022>
  ...
  while(1){
    ...
    572a:	daa50513          	addi	a0,a0,-598 # 84d0 <uthread_self+0x2062>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578c:	d68b8b93          	addi	s7,s7,-664 # 84f0 <uthread_self+0x2082>
    int free0 = countfree();
    int free1 = 0;
    ...
    579e:	d8ec8c93          	addi	s9,s9,-626 # 8528 <uthread_self+0x20ba>
      if (runtests(slowtests, justone)) {
    57a2:	00004c17          	auipc	s8,0x4
    57a6:	c3ec0c13          	addi	s8,s8,-962 # 93e0 <slowtests>
        printf("usertests slow tests starting\n");
    57aa:	00003d17          	auipc	s10,0x3
    57ae:	d5ed0d13          	addi	s10,s10,-674 # 8508 <uthread_self+0x209a>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58a4:	cb858593          	addi	a1,a1,-840 # 8558 <uthread_self+0x20ea>
    ...
    58ba:	cfa58593          	addi	a1,a1,-774 # 85b0 <uthread_self+0x2142>
    ...
    58d0:	cdc58593          	addi	a1,a1,-804 # 85a8 <uthread_self+0x213a>
  ...
  int continuous = 0;
    ...
    58fc:	c6850513          	addi	a0,a0,-920 # 8560 <uthread_self+0x20f2>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5928:	c6c50513          	addi	a0,a0,-916 # 8590 <uthread_self+0x2122>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cae:	c7650513          	addi	a0,a0,-906 # 8920 <digits>
    5cb2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d76:	00003b97          	auipc	s7,0x3
    5d7a:	baab8b93          	addi	s7,s7,-1110 # 8920 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5eb4:	bdf9                	j	5d92 <vprintf+0x60>
          s = "(null)";
    5eb6:	00003917          	auipc	s2,0x3
    5eba:	a6290913          	addi	s2,s2,-1438 # 8918 <uthread_self+0x24aa>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    6058:	c3478793          	addi	a5,a5,-972 # fc88 <base>
...
00000000000060e0 <uswtch>:
    60e0:	00153023          	sd	ra,0(a0)
    60e4:	00253423          	sd	sp,8(a0)
    60e8:	e900                	sd	s0,16(a0)
    60ea:	ed04                	sd	s1,24(a0)
    60ec:	03253023          	sd	s2,32(a0)
    60f0:	03353423          	sd	s3,40(a0)
    60f4:	03453823          	sd	s4,48(a0)
    60f8:	03553c23          	sd	s5,56(a0)
    60fc:	05653023          	sd	s6,64(a0)
    6100:	05753423          	sd	s7,72(a0)
    6104:	05853823          	sd	s8,80(a0)
    6108:	05953c23          	sd	s9,88(a0)
    610c:	07a53023          	sd	s10,96(a0)
    6110:	07b53423          	sd	s11,104(a0)
    6114:	0005b083          	ld	ra,0(a1)
    6118:	0085b103          	ld	sp,8(a1)
    611c:	6980                	ld	s0,16(a1)
    611e:	6d84                	ld	s1,24(a1)
    6120:	0205b903          	ld	s2,32(a1)
    6124:	0285b983          	ld	s3,40(a1)
    6128:	0305ba03          	ld	s4,48(a1)
    612c:	0385ba83          	ld	s5,56(a1)
    6130:	0405bb03          	ld	s6,64(a1)
    6134:	0485bb83          	ld	s7,72(a1)
    6138:	0505bc03          	ld	s8,80(a1)
    613c:	0585bc83          	ld	s9,88(a1)
    6140:	0605bd03          	ld	s10,96(a1)
    6144:	0685bd83          	ld	s11,104(a1)
    6148:	8082                	ret

000000000000614a <uthread_create>:
...
{
    614a:	1141                	addi	sp,sp,-16
    614c:	e422                	sd	s0,8(sp)
    614e:	0800                	addi	s0,sp,16
    int i;
    ids ++;
    6150:	00003797          	auipc	a5,0x3
    6154:	30c78793          	addi	a5,a5,780 # 945c <ids>
    6158:	0007a303          	lw	t1,0(a5)
    615c:	2305                	addiw	t1,t1,1
    615e:	0067a023          	sw	t1,0(a5)

    for (i = 0; i < MAX_UTHREADS; i++)
    6162:	0000b717          	auipc	a4,0xb
    6166:	ad670713          	addi	a4,a4,-1322 # 10c38 <uthreads+0xfa0>
    616a:	4781                	li	a5,0
    616c:	6605                	lui	a2,0x1
    616e:	02060613          	addi	a2,a2,32 # 1020 <linktest+0x12a>
    6172:	4811                	li	a6,4
    {
        if (uthreads[i].state == FREE)
    6174:	4314                	lw	a3,0(a4)
    6176:	c699                	beqz	a3,6184 <uthread_create+0x3a>
    for (i = 0; i < MAX_UTHREADS; i++)
    6178:	2785                	addiw	a5,a5,1
    617a:	9732                	add	a4,a4,a2
    617c:	ff079ce3          	bne	a5,a6,6174 <uthread_create+0x2a>
            break;
    }     
    ...
    if (i == MAX_UTHREADS)
        return -1;
    6180:	557d                	li	a0,-1
    6182:	a889                	j	61d4 <uthread_create+0x8a>
    if (i == MAX_UTHREADS)
    6184:	4711                	li	a4,4
    6186:	04e78a63          	beq	a5,a4,61da <uthread_create+0x90>

    uthreads[i].context.ra = (uint64)start_func;
    618a:	0000a897          	auipc	a7,0xa
    618e:	b0e88893          	addi	a7,a7,-1266 # fc98 <uthreads>
    6192:	00779693          	slli	a3,a5,0x7
    6196:	00f68633          	add	a2,a3,a5
    619a:	0616                	slli	a2,a2,0x5
    619c:	9646                	add	a2,a2,a7
    619e:	6805                	lui	a6,0x1
    61a0:	00c80e33          	add	t3,a6,a2
    61a4:	faae3423          	sd	a0,-88(t3)
    uthreads[i].context.sp = (uint64)(&uthreads[i].ustack[STACK_SIZE]);
    uthreads[i].context.sp += sizeof(uint64);
    61a8:	00f68733          	add	a4,a3,a5
    61ac:	0716                	slli	a4,a4,0x5
    uthreads[i].context.sp = (uint64)(&uthreads[i].ustack[STACK_SIZE]);
    61ae:	fa080513          	addi	a0,a6,-96 # fa0 <linktest+0xaa>
    61b2:	972a                	add	a4,a4,a0
    61b4:	9746                	add	a4,a4,a7
    uthreads[i].context.sp += sizeof(uint64);
    61b6:	0721                	addi	a4,a4,8
    61b8:	faee3823          	sd	a4,-80(t3)
    uthreads[i].state = RUNNABLE;
    61bc:	4709                	li	a4,2
    61be:	faee2023          	sw	a4,-96(t3)
    uthreads[i].priority = priority;
    61c2:	00be2c23          	sw	a1,24(t3)
    currentThread = &uthreads[i];
    61c6:	00003717          	auipc	a4,0x3
    61ca:	28c73d23          	sd	a2,666(a4) # 9460 <currentThread>

    currentThread->pid = ids;
    61ce:	006e2e23          	sw	t1,28(t3)

    return 0;
    61d2:	4501                	li	a0,0
}
    61d4:	6422                	ld	s0,8(sp)
    61d6:	0141                	addi	sp,sp,16
    61d8:	8082                	ret
        return -1;
    61da:	557d                	li	a0,-1
    61dc:	bfe5                	j	61d4 <uthread_create+0x8a>

00000000000061de <get_state>:
...
char* get_state(enum tstate s){
    61de:	1141                	addi	sp,sp,-16
    61e0:	e422                	sd	s0,8(sp)
    61e2:	0800                	addi	s0,sp,16
  switch (s)
    61e4:	4705                	li	a4,1
    61e6:	02e50763          	beq	a0,a4,6214 <get_state+0x36>
    61ea:	87aa                	mv	a5,a0
    61ec:	4709                	li	a4,2
  case FREE:
    return "FREE";
  ...
  case RUNNABLE:
    return "RUNNABLE";
    61ee:	00002517          	auipc	a0,0x2
    61f2:	75250513          	addi	a0,a0,1874 # 8940 <digits+0x20>
  switch (s)
    61f6:	00e78763          	beq	a5,a4,6204 <get_state+0x26>
  }

  return "ERROR";
    61fa:	00002517          	auipc	a0,0x2
    61fe:	73e50513          	addi	a0,a0,1854 # 8938 <digits+0x18>
  switch (s)
    6202:	c781                	beqz	a5,620a <get_state+0x2c>
}
    6204:	6422                	ld	s0,8(sp)
    6206:	0141                	addi	sp,sp,16
    6208:	8082                	ret
    return "FREE";
    620a:	00002517          	auipc	a0,0x2
    620e:	74e50513          	addi	a0,a0,1870 # 8958 <digits+0x38>
    6212:	bfcd                	j	6204 <get_state+0x26>
  switch (s)
    6214:	00002517          	auipc	a0,0x2
    6218:	73c50513          	addi	a0,a0,1852 # 8950 <digits+0x30>
    621c:	b7e5                	j	6204 <get_state+0x26>

000000000000621e <find_next>:
...
struct uthread *find_next(enum sched_priority priority){
  ...
  j = (currentThread - uthreads + 1) % MAX_UTHREADS;
    6224:	00003717          	auipc	a4,0x3
    6228:	23c73703          	ld	a4,572(a4) # 9460 <currentThread>
    622c:	0000a797          	auipc	a5,0xa
    6230:	a6c78793          	addi	a5,a5,-1428 # fc98 <uthreads>
    6234:	8f1d                	sub	a4,a4,a5
    6236:	8715                	srai	a4,a4,0x5
    6238:	00000797          	auipc	a5,0x0
    623c:	2587b783          	ld	a5,600(a5) # 6490 <uthread_self+0x22>
    6240:	02f70733          	mul	a4,a4,a5
    6244:	0705                	addi	a4,a4,1
    6246:	43f75793          	srai	a5,a4,0x3f
    624a:	03e7d693          	srli	a3,a5,0x3e
    624e:	00d707b3          	add	a5,a4,a3
    6252:	8b8d                	andi	a5,a5,3
    6254:	8f95                	sub	a5,a5,a3
    6256:	4691                	li	a3,4

  for(i = 0; i < MAX_UTHREADS; i++){
    if((uthreads[j].state == RUNNABLE || uthreads[j].state == RUNNING) && uthreads[j].priority == priority){
    6258:	0000a597          	auipc	a1,0xa
    625c:	a4058593          	addi	a1,a1,-1472 # fc98 <uthreads>
    6260:	6605                	lui	a2,0x1
    6262:	4805                	li	a6,1
    6264:	a819                	j	627a <find_next+0x5c>
      next = &uthreads[j];
      break;
    }
    j = (j+1) % MAX_UTHREADS;    
    6266:	2785                	addiw	a5,a5,1
    6268:	41f7d71b          	sraiw	a4,a5,0x1f
    626c:	01e7571b          	srliw	a4,a4,0x1e
    6270:	9fb9                	addw	a5,a5,a4
    6272:	8b8d                	andi	a5,a5,3
    6274:	9f99                	subw	a5,a5,a4
  for(i = 0; i < MAX_UTHREADS; i++){
    6276:	36fd                	addiw	a3,a3,-1
    6278:	ce9d                	beqz	a3,62b6 <find_next+0x98>
    if((uthreads[j].state == RUNNABLE || uthreads[j].state == RUNNING) && uthreads[j].priority == priority){
    627a:	00779713          	slli	a4,a5,0x7
    627e:	973e                	add	a4,a4,a5
    6280:	0716                	slli	a4,a4,0x5
    6282:	972e                	add	a4,a4,a1
    6284:	9732                	add	a4,a4,a2
    6286:	fa072703          	lw	a4,-96(a4)
    628a:	377d                	addiw	a4,a4,-1
    628c:	fce86de3          	bltu	a6,a4,6266 <find_next+0x48>
    6290:	00779713          	slli	a4,a5,0x7
    6294:	973e                	add	a4,a4,a5
    6296:	0716                	slli	a4,a4,0x5
    6298:	972e                	add	a4,a4,a1
    629a:	9732                	add	a4,a4,a2
    629c:	4f18                	lw	a4,24(a4)
    629e:	fca714e3          	bne	a4,a0,6266 <find_next+0x48>
      next = &uthreads[j];
    62a2:	00779513          	slli	a0,a5,0x7
    62a6:	953e                	add	a0,a0,a5
    62a8:	0516                	slli	a0,a0,0x5
    62aa:	0000a797          	auipc	a5,0xa
    62ae:	9ee78793          	addi	a5,a5,-1554 # fc98 <uthreads>
    62b2:	953e                	add	a0,a0,a5
      break;
    62b4:	a011                	j	62b8 <find_next+0x9a>
  struct uthread* next = 0;
    62b6:	4501                	li	a0,0
  }
  ...
  return next;
    ...
    62b8:	6422                	ld	s0,8(sp)
    62ba:	0141                	addi	sp,sp,16
    62bc:	8082                	ret

00000000000062be <schedule>:
void schedule(){
    62be:	1101                	addi	sp,sp,-32
    62c0:	ec06                	sd	ra,24(sp)
    62c2:	e822                	sd	s0,16(sp)
    62c4:	e426                	sd	s1,8(sp)
    62c6:	1000                	addi	s0,sp,32
  cur = currentThread;
    62c8:	00003497          	auipc	s1,0x3
    62cc:	1984b483          	ld	s1,408(s1) # 9460 <currentThread>
  next = find_next(HIGH);
    62d0:	4509                	li	a0,2
    62d2:	00000097          	auipc	ra,0x0
    62d6:	f4c080e7          	jalr	-180(ra) # 621e <find_next>
  if(next == 0)
    62da:	c915                	beqz	a0,630e <schedule+0x50>
  currentThread = next;
    62dc:	00003797          	auipc	a5,0x3
    62e0:	18a7b223          	sd	a0,388(a5) # 9460 <currentThread>
  currentThread->state = RUNNING;
    62e4:	6785                	lui	a5,0x1
    62e6:	00f50733          	add	a4,a0,a5
    62ea:	4685                	li	a3,1
    62ec:	fad72023          	sw	a3,-96(a4)
  uswtch(&cur->context, &next->context);
    62f0:	fa878793          	addi	a5,a5,-88 # fa8 <linktest+0xb2>
    62f4:	00f505b3          	add	a1,a0,a5
    62f8:	00f48533          	add	a0,s1,a5
    62fc:	00000097          	auipc	ra,0x0
    6300:	de4080e7          	jalr	-540(ra) # 60e0 <uswtch>
}
    6304:	60e2                	ld	ra,24(sp)
    6306:	6442                	ld	s0,16(sp)
    6308:	64a2                	ld	s1,8(sp)
    630a:	6105                	addi	sp,sp,32
    630c:	8082                	ret
    next = find_next(MEDIUM);
    630e:	4505                	li	a0,1
    6310:	00000097          	auipc	ra,0x0
    6314:	f0e080e7          	jalr	-242(ra) # 621e <find_next>
  if(next == 0)
    6318:	f171                	bnez	a0,62dc <schedule+0x1e>
    next = find_next(LOW);
    631a:	00000097          	auipc	ra,0x0
    631e:	f04080e7          	jalr	-252(ra) # 621e <find_next>
  if(next == 0)
    6322:	fd4d                	bnez	a0,62dc <schedule+0x1e>
    exit(-1);
    6324:	557d                	li	a0,-1
    6326:	00000097          	auipc	ra,0x0
    632a:	8a0080e7          	jalr	-1888(ra) # 5bc6 <exit>

000000000000632e <uthread_yield>:
{
    632e:	1141                	addi	sp,sp,-16
    6330:	e406                	sd	ra,8(sp)
    6332:	e022                	sd	s0,0(sp)
    6334:	0800                	addi	s0,sp,16
  currentThread->state = RUNNABLE;
    6336:	00003797          	auipc	a5,0x3
    633a:	12a7b783          	ld	a5,298(a5) # 9460 <currentThread>
    633e:	6705                	lui	a4,0x1
    6340:	97ba                	add	a5,a5,a4
    6342:	4709                	li	a4,2
    6344:	fae7a023          	sw	a4,-96(a5)
  schedule();
    6348:	00000097          	auipc	ra,0x0
    634c:	f76080e7          	jalr	-138(ra) # 62be <schedule>
}
    6350:	60a2                	ld	ra,8(sp)
    6352:	6402                	ld	s0,0(sp)
    6354:	0141                	addi	sp,sp,16
    6356:	8082                	ret

0000000000006358 <uthread_exit>:

void uthread_exit()
{
    6358:	1141                	addi	sp,sp,-16
    635a:	e406                	sd	ra,8(sp)
    635c:	e022                	sd	s0,0(sp)
    635e:	0800                	addi	s0,sp,16
  currentThread->state = FREE;
    6360:	00003797          	auipc	a5,0x3
    6364:	1007b783          	ld	a5,256(a5) # 9460 <currentThread>
    6368:	6705                	lui	a4,0x1
    636a:	97ba                	add	a5,a5,a4
    636c:	fa07a023          	sw	zero,-96(a5)
  int remainingThreads = 0;
  for (int i = 0; i < MAX_UTHREADS; i++) {
    6370:	0000b797          	auipc	a5,0xb
    6374:	8c878793          	addi	a5,a5,-1848 # 10c38 <uthreads+0xfa0>
    6378:	0000f597          	auipc	a1,0xf
    637c:	94058593          	addi	a1,a1,-1728 # 14cb8 <uthreads+0x5020>
  int remainingThreads = 0;
    6380:	4501                	li	a0,0
    if (uthreads[i].state == RUNNABLE) 
    6382:	4609                	li	a2,2
  for (int i = 0; i < MAX_UTHREADS; i++) {
    6384:	6685                	lui	a3,0x1
    6386:	02068693          	addi	a3,a3,32 # 1020 <linktest+0x12a>
    638a:	a021                	j	6392 <uthread_exit+0x3a>
    638c:	97b6                	add	a5,a5,a3
    638e:	00b78763          	beq	a5,a1,639c <uthread_exit+0x44>
    if (uthreads[i].state == RUNNABLE) 
    6392:	4398                	lw	a4,0(a5)
    6394:	fec71ce3          	bne	a4,a2,638c <uthread_exit+0x34>
      remainingThreads++;
    6398:	2505                	addiw	a0,a0,1
    639a:	bfcd                	j	638c <uthread_exit+0x34>
  }

  if (remainingThreads == 0){
    639c:	c909                	beqz	a0,63ae <uthread_exit+0x56>
    exit(0);
  }
  else 
  {
    ...
    63a2:	f20080e7          	jalr	-224(ra) # 62be <schedule>
  }
}
    63a6:	60a2                	ld	ra,8(sp)
    63a8:	6402                	ld	s0,0(sp)
    63aa:	0141                	addi	sp,sp,16
    63ac:	8082                	ret
    exit(0);
    63ae:	00000097          	auipc	ra,0x0
    63b2:	818080e7          	jalr	-2024(ra) # 5bc6 <exit>

00000000000063b6 <uthread_set_priority>:

enum sched_priority uthread_set_priority(enum sched_priority priority)
{
    63b6:	1141                	addi	sp,sp,-16
    63b8:	e422                	sd	s0,8(sp)
    63ba:	0800                	addi	s0,sp,16
  enum sched_priority prevPriority = currentThread->priority;
    63bc:	00003797          	auipc	a5,0x3
    63c0:	0a47b783          	ld	a5,164(a5) # 9460 <currentThread>
    63c4:	6705                	lui	a4,0x1
    63c6:	97ba                	add	a5,a5,a4
    63c8:	4f98                	lw	a4,24(a5)
  currentThread->priority = priority;
    63ca:	cf88                	sw	a0,24(a5)
  return prevPriority;
}
    63cc:	853a                	mv	a0,a4
    63ce:	6422                	ld	s0,8(sp)
    63d0:	0141                	addi	sp,sp,16
    63d2:	8082                	ret

00000000000063d4 <uthread_get_priority>:

enum sched_priority uthread_get_priority()
{
    63d4:	1141                	addi	sp,sp,-16
    63d6:	e422                	sd	s0,8(sp)
    63d8:	0800                	addi	s0,sp,16
    return currentThread->priority;
    63da:	00003797          	auipc	a5,0x3
    63de:	0867b783          	ld	a5,134(a5) # 9460 <currentThread>
    63e2:	6705                	lui	a4,0x1
    63e4:	97ba                	add	a5,a5,a4
}
    63e6:	4f88                	lw	a0,24(a5)
    63e8:	6422                	ld	s0,8(sp)
    63ea:	0141                	addi	sp,sp,16
    63ec:	8082                	ret

00000000000063ee <uthread_start_all>:

int uthreadStarted = 0;

int uthread_start_all() {
    63ee:	7175                	addi	sp,sp,-144
    63f0:	e506                	sd	ra,136(sp)
    63f2:	e122                	sd	s0,128(sp)
    63f4:	fca6                	sd	s1,120(sp)
    63f6:	0900                	addi	s0,sp,144
  if (uthreadStarted) {
    63f8:	00003497          	auipc	s1,0x3
    63fc:	0604a483          	lw	s1,96(s1) # 9458 <uthreadStarted>
    6400:	e4ad                	bnez	s1,646a <uthread_start_all+0x7c>
    return -1;
  }
  uthreadStarted = 1;
    6402:	4785                	li	a5,1
    6404:	00003717          	auipc	a4,0x3
    6408:	04f72a23          	sw	a5,84(a4) # 9458 <uthreadStarted>
  ...
  next = find_next(HIGH);
    ...
    6412:	e10080e7          	jalr	-496(ra) # 621e <find_next>
  if(next == 0)
    6416:	c915                	beqz	a0,644a <uthread_start_all+0x5c>
  if(next == 0)
    next = find_next(LOW);
  if(next == 0)
    exit(-1);
  ...
  currentThread = next;
    6418:	00003797          	auipc	a5,0x3
    641c:	04a7b423          	sd	a0,72(a5) # 9460 <currentThread>
  currentThread->state = RUNNING;
    6420:	6585                	lui	a1,0x1
    6422:	00b507b3          	add	a5,a0,a1
    6426:	4705                	li	a4,1
    6428:	fae7a023          	sw	a4,-96(a5)

  uswtch(&dummyContext, &currentThread->context);
    642c:	fa858593          	addi	a1,a1,-88 # fa8 <linktest+0xb2>
    6430:	95aa                	add	a1,a1,a0
    6432:	f7040513          	addi	a0,s0,-144
    6436:	00000097          	auipc	ra,0x0
    643a:	caa080e7          	jalr	-854(ra) # 60e0 <uswtch>

  return 0;
}
    643e:	8526                	mv	a0,s1
    6440:	60aa                	ld	ra,136(sp)
    6442:	640a                	ld	s0,128(sp)
    6444:	74e6                	ld	s1,120(sp)
    6446:	6149                	addi	sp,sp,144
    6448:	8082                	ret
    next = find_next(MEDIUM);
    644a:	4505                	li	a0,1
    644c:	00000097          	auipc	ra,0x0
    6450:	dd2080e7          	jalr	-558(ra) # 621e <find_next>
  if(next == 0)
    6454:	f171                	bnez	a0,6418 <uthread_start_all+0x2a>
    next = find_next(LOW);
    6456:	00000097          	auipc	ra,0x0
    645a:	dc8080e7          	jalr	-568(ra) # 621e <find_next>
  if(next == 0)
    645e:	fd4d                	bnez	a0,6418 <uthread_start_all+0x2a>
    exit(-1);
    6460:	557d                	li	a0,-1
    6462:	fffff097          	auipc	ra,0xfffff
    6466:	764080e7          	jalr	1892(ra) # 5bc6 <exit>
    return -1;
    646a:	54fd                	li	s1,-1
    646c:	bfc9                	j	643e <uthread_start_all+0x50>

000000000000646e <uthread_self>:


struct uthread *uthread_self()
{
    646e:	1141                	addi	sp,sp,-16
    6470:	e422                	sd	s0,8(sp)
    6472:	0800                	addi	s0,sp,16
    return currentThread;
    6474:	00003517          	auipc	a0,0x3
    6478:	fec53503          	ld	a0,-20(a0) # 9460 <currentThread>
    647c:	6422                	ld	s0,8(sp)
    647e:	0141                	addi	sp,sp,16
    6480:	8082                	ret
